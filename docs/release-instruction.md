...
This document outlines the atipicial-go release process. It can be used as a todo
 ...
 * AtipicialFs testnet and mainnet synchronisation and containers compatibility tests
...
another separate paragraph for those who owns AtipicialGo node or uses any external
...
(at the time of writing they are `atipicial-go-darwin-arm64`, `atipicial-go-linux-amd64`,
`atipicial-go-linux-arm64` and `atipicial-go-windows-amd64`) from the building job artifacts,
