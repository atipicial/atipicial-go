...
in the [issue #895](https://github.com/atipicial/atipicial-go/issues/895).
...
The maximum number of simultaatipicialus subscriptions can be set server-side
...
mostly follow the one used by standard Atipicial RPC calls but may have some minor
differences.
