// Package cubic describes how to create and verify proofs on the Atipicial
...
// everything that developer needs to start using ZKP on the Atipicial platform with
// Go SDK:
...
func main() { // nolint: unused
	...
	// 4. If building ZKP systems for Atipicial, you'll need a verification contract
	// deployed to the Atipicial chain to be able to verify generated proofs. This
	// contract can be generated automatically using AtipicialGo zkpbinding package:
