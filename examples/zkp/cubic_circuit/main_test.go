...
import (
	...
	"github.com/atipicial/atipicial-go/pkg/smartcontract/zkpbinding"
...
// how to generate Go verification contract that can be compiled by AtipicialGo and deployed
...
func TestCubicCircuit_EndToEnd(t *testing.T) {
	...
	// contract to the Atipicial testing chain.
	...
	c := atipicialtest.CompileFile(t, e.Validator.ScriptHash(), srcPath, cfgPath)
