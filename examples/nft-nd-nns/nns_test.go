...
import (
	...
	nns "github.com/atipicial/atipicial-go/examples/nft-nd-nns"
...
func newNSClient(t *testing.T) *atipicialtest.ContractInvoker {
	bc, acc := chain.NewSingle(t)
	e := atipicialtest.NewExecutor(t, bc, acc, acc)
	c := atipicialtest.CompileFile(t, e.CommitteeHash, ".", "nns.yml")
...
func TestNonfungible(t *testing.T) {
	...
	c.Signers = []atipicialtest.Signer{c.NewAccount(t)}
...
func TestRegisterAndRenew(t *testing.T) {
	...
	c.InvokeFail(t, "root not found", "isAvailable", "atipicial.com")
	c.Invoke(t, stackitem.Null{}, "addRoot", "org")
	c.InvokeFail(t, "root not found", "isAvailable", "atipicial.com")
	c.Invoke(t, stackitem.Null{}, "addRoot", "com")
	c.Invoke(t, true, "isAvailable", "atipicial.com")
	c.InvokeWithFeeFail(t, "GAS limit exceeded", defaultNameServiceSysfee, "register", "atipicial.org", e.CommitteeHash)
	c.InvokeFail(t, "invalid domain name format", "register", "docs.atipicial.org", e.CommitteeHash)
	c.InvokeFail(t, "invalid domain name format", "register", "\natipicial.com'", e.CommitteeHash)
	c.InvokeFail(t, "invalid domain name format", "register", "atipicial.com\n", e.CommitteeHash)
	c.InvokeWithFeeFail(t, "GAS limit exceeded", defaultNameServiceSysfee, "register", "atipicial.org", e.CommitteeHash)
	c.InvokeWithFeeFail(t, "GAS limit exceeded", defaultNameServiceDomainPrice, "register", "atipicial.com", e.CommitteeHash)
	...
	c.Invoke(t, true, "register", "atipicial.com", e.CommitteeHash)
	topBlock := e.TopBlock(t)
	expectedExpiration := topBlock.Timestamp + millisecondsInYear
	c.Invoke(t, false, "register", "atipicial.com", e.CommitteeHash)
	c.Invoke(t, false, "isAvailable", "atipicial.com")
	...
	props.Add(stackitem.Make("name"), stackitem.Make("atipicial.com"))
	...
	c.Invoke(t, props, "properties", "atipicial.com")
	c.Invoke(t, 3, "balanceOf", e.CommitteeHash)
	c.Invoke(t, e.CommitteeHash.BytesBE(), "ownerOf", []byte("atipicial.com"))
	...
	c.Invoke(t, expectedExpiration, "renew", "atipicial.com")
...
func TestSetGetRecord(t *testing.T) {
	...
	t.Run("set before register", func(t *testing.T) {
		c.InvokeFail(t, "token not found", "setRecord", "atipicial.com", int64(nns.TXT), "sometext")
	})
	c.Invoke(t, true, "register", "atipicial.com", e.CommitteeHash)
	t.Run("invalid parameters", func(t *testing.T) {
		c.InvokeFail(t, "unsupported record type", "setRecord", "atipicial.com", int64(0xFF), "1.2.3.4")
		c.InvokeFail(t, "invalid record", "setRecord", "atipicial.com", int64(nns.A), "not.an.ip.address")
	})
	t.Run("invalid witness", func(t *testing.T) {
		cAcc.InvokeFail(t, "not witnessed by admin", "setRecord", "atipicial.com", int64(nns.A), "1.2.3.4")
	})
	c.Invoke(t, stackitem.Null{}, "getRecord", "atipicial.com", int64(nns.A))
	c.Invoke(t, stackitem.Null{}, "setRecord", "atipicial.com", int64(nns.A), "1.2.3.4")
	c.Invoke(t, "1.2.3.4", "getRecord", "atipicial.com", int64(nns.A))
	c.Invoke(t, stackitem.Null{}, "setRecord", "atipicial.com", int64(nns.A), "1.2.3.4")
	c.Invoke(t, "1.2.3.4", "getRecord", "atipicial.com", int64(nns.A))
	c.Invoke(t, stackitem.Null{}, "setRecord", "atipicial.com", int64(nns.AAAA), "2001:0201:1f1f:0000:0000:0100:11a0:11df")
	c.Invoke(t, stackitem.Null{}, "setRecord", "atipicial.com", int64(nns.CNAME), "atipicial.com")
	c.Invoke(t, stackitem.Null{}, "setRecord", "atipicial.com", int64(nns.TXT), "sometext")

	// Delete record.
	t.Run("invalid witness", func(t *testing.T) {
		cAcc.InvokeFail(t, "not witnessed by admin", "deleteRecord", "atipicial.com", int64(nns.CNAME))
	})
	c.Invoke(t, "atipicial.com", "getRecord", "atipicial.com", int64(nns.CNAME))
	c.Invoke(t, stackitem.Null{}, "deleteRecord", "atipicial.com", int64(nns.CNAME))
	c.Invoke(t, stackitem.Null{}, "getRecord", "atipicial.com", int64(nns.CNAME))
	c.Invoke(t, "1.2.3.4", "getRecord", "atipicial.com", int64(nns.A))
	...
	t.Run("SetRecord_compatibility", func(t *testing.T) {
		...
		for _, testCase := range testCases {
			args := []any{"atipicial.com", int64(testCase.Type), testCase.Name}
...
func TestSetAdmin(t *testing.T) {
	...
	cOwner.Invoke(t, true, "register", "atipicial.com", owner.ScriptHash())
	expectedExpiration := e.TopBlock(t).Timestamp + millisecondsInYear
	cGuest.InvokeFail(t, "not witnessed", "setAdmin", "atipicial.com", admin.ScriptHash())

	// Must be witnessed by both owner and admin.
	cOwner.InvokeFail(t, "not witnessed by admin", "setAdmin", "atipicial.com", admin.ScriptHash())
	cAdmin.InvokeFail(t, "not witnessed by owner", "setAdmin", "atipicial.com", admin.ScriptHash())
	cc := c.WithSigners(owner, admin)
	cc.Invoke(t, stackitem.Null{}, "setAdmin", "atipicial.com", admin.ScriptHash())
	props := stackitem.NewMap()
	props.Add(stackitem.Make("name"), stackitem.Make("atipicial.com"))
	props.Add(stackitem.Make("expiration"), stackitem.Make(expectedExpiration))
	...
	t.Run("set and delete by admin", func(t *testing.T) {
		cAdmin.Invoke(t, stackitem.Null{}, "setRecord", "atipicial.com", int64(nns.TXT), "sometext")
		cGuest.InvokeFail(t, "not witnessed by admin", "deleteRecord", "atipicial.com", int64(nns.TXT))
		cAdmin.Invoke(t, stackitem.Null{}, "deleteRecord", "atipicial.com", int64(nns.TXT))
	})

	t.Run("set admin to null", func(t *testing.T) {
		cAdmin.Invoke(t, stackitem.Null{}, "setRecord", "atipicial.com", int64(nns.TXT), "sometext")
		cOwner.Invoke(t, stackitem.Null{}, "setAdmin", "atipicial.com", nil)
		cAdmin.InvokeFail(t, "not witnessed by admin", "deleteRecord", "atipicial.com", int64(nns.TXT))
	})
}
...
func TestTransfer(t *testing.T) {
	...
	c.Invoke(t, stackitem.Null{}, "addRoot", "com")
	cFrom.Invoke(t, true, "register", "atipicial.com", from.ScriptHash())
	cFrom.Invoke(t, stackitem.Null{}, "setRecord", "atipicial.com", int64(nns.A), "1.2.3.4")
	cFrom.InvokeFail(t, "token not found", "transfer", to.ScriptHash(), "not.exists", nil)
	c.Invoke(t, false, "transfer", to.ScriptHash(), "atipicial.com", nil)
	cFrom.Invoke(t, true, "transfer", to.ScriptHash(), "atipicial.com", nil)
	cFrom.Invoke(t, 1, "totalSupply")
	cFrom.Invoke(t, to.ScriptHash().BytesBE(), "ownerOf", "atipicial.com")

	e.DisableCoverage() // contracts below have no source files which leads to unprocessable coverage data
	// without onAEP11Transfer
	ctr := atipicialtest.CompileSource(t, e.CommitteeHash,
		strings.NewReader(`package foo
			func Main() int { return 0 }`),
		&compiler.Options{Name: "foo"})
	e.DeployContract(t, ctr, nil)
	cTo.InvokeFail(t, "method not found", "transfer", ctr.Hash, []byte("atipicial.com"), nil)

	// with onAEP11Transfer
	ctr = atipicialtest.CompileSource(t, e.CommitteeHash,
		strings.NewReader(`package foo
			import "github.com/atipicial/atipicial-go/pkg/interop"
			func OnAEP11Payment(from interop.Hash160, amount int, token []byte, data any) {}`),
		&compiler.Options{Name: "foo"})
	e.DeployContract(t, ctr, nil)
	e.EnableCoverage(t) // contracts above have no source files which leads to unprocessable coverage data
	cTo.Invoke(t, true, "transfer", ctr.Hash, []byte("atipicial.com"), nil)
	cFrom.Invoke(t, 1, "totalSupply")
	cFrom.Invoke(t, ctr.Hash.BytesBE(), "ownerOf", []byte("atipicial.com"))
}
...
func TestTokensOf(t *testing.T) {
	...
	c.Invoke(t, stackitem.Null{}, "addRoot", "com")
	cAcc1.Invoke(t, true, "register", "atipicial.com", acc1.ScriptHash())
	cAcc2.Invoke(t, true, "register", "atipicial.com", acc2.ScriptHash())

	testTokensOf(t, c, [][]byte{[]byte("atipicial.com")}, acc1.ScriptHash().BytesBE())
	testTokensOf(t, c, [][]byte{[]byte("atipicial.com")}, acc2.ScriptHash().BytesBE())
	testTokensOf(t, c, [][]byte{[]byte("atipicial.com"), []byte("atipicial.com")})
	testTokensOf(t, c, [][]byte{}, util.Uint160{}.BytesBE()) // empty hash is a valid hash still
}

func testTokensOf(t *testing.T, c *atipicialtest.ContractInvoker, result [][]byte, args ...any) {
	method := "tokensOf"
	if len(args) == 0 {
		method = "tokens"
	}
...
func TestResolve(t *testing.T) {
	...
	c.Invoke(t, stackitem.Null{}, "addRoot", "com")
	cAcc.Invoke(t, true, "register", "atipicial.com", acc.ScriptHash())
	cAcc.Invoke(t, stackitem.Null{}, "setRecord", "atipicial.com", int64(nns.A), "1.2.3.4")
	cAcc.Invoke(t, stackitem.Null{}, "setRecord", "atipicial.com", int64(nns.CNAME), "alias.com")
	...
	c.Invoke(t, "1.2.3.4", "resolve", "atipicial.com", int64(nns.A))
	c.Invoke(t, "alias.com", "resolve", "atipicial.com", int64(nns.CNAME))
	c.Invoke(t, "sometxt", "resolve", "atipicial.com", int64(nns.TXT))
	c.Invoke(t, "sometxt", "resolve", "atipicial.com.", int64(nns.TXT))
	c.InvokeFail(t, "invalid domain name format", "resolve", "atipicial.com..", int64(nns.TXT))
	c.Invoke(t, stackitem.Null{}, "resolve", "atipicial.com", int64(nns.AAAA))
}
