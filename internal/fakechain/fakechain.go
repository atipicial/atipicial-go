...
// GetAEP11Contracts implements the Blockchainer interface.
func (chain *FakeChain) GetAEP11Contracts() []util.Uint160 {
	panic("TODO")
}

// GetAEP17Contracts implements the Blockchainer interface.
func (chain *FakeChain) GetAEP17Contracts() []util.Uint160 {
	panic("TODO")
}
...
// ForEachAEP11Transfer implements the Blockchainer interface.
func (chain *FakeChain) ForEachAEP11Transfer(util.Uint160, uint64, func(*state.AEP11Transfer) (bool, error)) error {
	panic("TODO")
}

// ForEachAEP17Transfer implements the Blockchainer interface.
func (chain *FakeChain) ForEachAEP17Transfer(util.Uint160, uint64, func(*state.AEP17Transfer) (bool, error)) error {
	panic("TODO")
}
