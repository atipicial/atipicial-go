...
1. Check open [issues](https://github.com/atipicial/atipicial-go/issues) and
[pull requests](https://github.com/atipicial/atipicial-go/pulls) for existing discussions.
