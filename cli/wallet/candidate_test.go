...
func TestRegisterCandidate(t *testing.T) {
	...
	e.Run(t, "atipicial-go", "wallet", "aep17", "multitransfer",
		...
		"--force",
		"ATC:"+validatorAddress+":10",
		"GAS:"+validatorAddress+":10000")
	e.CheckTxPersisted(t)

	e.Run(t, "atipicial-go", "query", "committee",
		"--rpc-endpoint", "http://"+e.RPC.Addresses()[0])
	e.CheckNextLine(t, "^\\s*"+validatorHex)

	e.Run(t, "atipicial-go", "query", "candidates",
		"--rpc-endpoint", "http://"+e.RPC.Addresses()[0])
	e.CheckNextLine(t, "^\\s*Key.+$") // Header.
	e.CheckEOF(t)

	// missing address
	e.RunWithErrorCheck(t, `Required flag "address" not set`, "atipicial-go", "wallet", "candidate", "register",
		"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
		"--wallet", testcli.ValidatorWallet)

	// additional parameter
	e.RunWithError(t, "atipicial-go", "wallet", "candidate", "register",
		"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
		"--wallet", testcli.ValidatorWallet,
	...
	e.In.WriteString("one\r")
	e.Run(t, "atipicial-go", "wallet", "candidate", "register",
		"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
		"--wallet", testcli.ValidatorWallet,
		"--address", validatorAddress,
		"--force")
	...
	t.Run("VoteUnvote", func(t *testing.T) {
		...
		e.RunWithError(t, "atipicial-go", "wallet", "candidate", "vote",
			"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
			"--wallet", testcli.ValidatorWallet,
			"--address", validatorAddress,
		...
		e.In.WriteString("one\r")
		e.Run(t, "atipicial-go", "wallet", "candidate", "vote",
			"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
			"--wallet", testcli.ValidatorWallet,
			"--address", validatorAddress,
		...
		// check state
		e.Run(t, "atipicial-go", "query", "voter",
			"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
			validatorAddress)
	...
	// missing address
	e.RunWithErrorCheck(t, `Required flag "address" not set`, "atipicial-go", "wallet", "candidate", "unregister",
		"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
		"--wallet", testcli.ValidatorWallet)
	// additional argument
	e.RunWithError(t, "atipicial-go", "wallet", "candidate", "unregister",
		"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
		"--wallet", testcli.ValidatorWallet,
		"--address", validatorAddress,
		"argument")
	...
	e.In.WriteString("one\r")
	e.Run(t, "atipicial-go", "wallet", "candidate", "unregister",
		"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
		"--wallet", testcli.ValidatorWallet,
		"--address", validatorAddress,
		"--force")
	...
	e.RunWithError(t, "atipicial-go", "query", "voter", "--rpc-endpoint", "http://"+e.RPC.Addresses()[0])
	// Excessive parameters.
	e.RunWithError(t, "atipicial-go", "query", "voter", "--rpc-endpoint", "http://"+e.RPC.Addresses()[0], validatorAddress, validatorAddress)
	e.RunWithError(t, "atipicial-go", "query", "committee", "--rpc-endpoint", "http://"+e.RPC.Addresses()[0], "something")
	e.RunWithError(t, "atipicial-go", "query", "candidates", "--rpc-endpoint", "http://"+e.RPC.Addresses()[0], "something")
