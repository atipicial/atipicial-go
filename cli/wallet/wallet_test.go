...
func TestWalletAccountRemove(t *testing.T) {
	...
	e.In.WriteString("pass\r")
	e.Run(t, "atipicial-go", "wallet", "init", "--wallet", walletPath, "--account")

	e.In.WriteString("acc2\r")
	e.In.WriteString("pass\r")
	e.In.WriteString("pass\r")
	e.Run(t, "atipicial-go", "wallet", "create", "--wallet", walletPath)

	w, err := wallet.NewWalletFromFile(walletPath)
	require.NoError(t, err)

	t.Run("missing wallet", func(t *testing.T) {
		e.RunWithErrorCheck(t, `Required flag "address" not set`, "atipicial-go", "wallet", "remove")
	})
	t.Run("missing address", func(t *testing.T) {
		e.RunWithErrorCheck(t, `Required flag "address" not set`, "atipicial-go", "wallet", "remove", "--wallet", walletPath)
	})
	t.Run("invalid address", func(t *testing.T) {
		e.RunWithError(t, "atipicial-go", "wallet", "remove", "--wallet", walletPath,
	...
	t.Run("askForConsent > no", func(t *testing.T) {
		e.In.WriteString("no")
		e.Run(t, "atipicial-go", "wallet", "remove", "--wallet", walletPath,
			"--address", addr)
...
func TestWalletChangePassword(t *testing.T) {
	...
	t.Run("missing wallet path", func(t *testing.T) {
		e.RunWithError(t, "atipicial-go", "wallet", "change-password")
	})
	t.Run("EOF reading old password", func(t *testing.T) {
		e.RunWithError(t, "atipicial-go", "wallet", "change-password", "--wallet", walletPath)
	})
	...
	t.Run("no account", func(t *testing.T) {
		e.RunWithError(t, "atipicial-go", "wallet", "change-password", "--wallet", walletPath, "--address", "NVTiAjNgagDkTr5HTzDmQP9kPwPHN5BgVq")
	})
	t.Run("bad new password, multiaccount", func(t *testing.T) {
		e.In.WriteString("pass\r")
		e.In.WriteString("pass1\r")
		e.In.WriteString("pass2\r")
		e.RunWithError(t, "atipicial-go", "wallet", "change-password", "--wallet", walletPath, "--address", addr1)
	})
	t.Run("good, multiaccount", func(t *testing.T) {
		e.In.WriteString("pass\r")
		e.In.WriteString("asdf\r")
		e.In.WriteString("asdf\r")
		e.Run(t, "atipicial-go", "wallet", "change-password", "--wallet", walletPath)
	})
	t.Run("good, single account", func(t *testing.T) {
		e.In.WriteString("asdf\r")
		e.In.WriteString("jkl\r")
		e.In.WriteString("jkl\r")
		e.Run(t, "atipicial-go", "wallet", "change-password", "--wallet", walletPath, "--address", addr1)
	})
	...
	t.Run("good, second account", func(t *testing.T) {
		...
		e.In.WriteString("jkl\r")
		e.In.WriteString("jkl\r")
		e.Run(t, "atipicial-go", "wallet", "change-password", "--wallet", walletPath, "--address", addr2)
	})
...
func TestWalletInit(t *testing.T) {
	...
	t.Run("missing path", func(t *testing.T) {
		e.RunWithError(t, "atipicial-go", "wallet", "init")
	})
	t.Run("invalid path", func(t *testing.T) {
		e.RunWithError(t, "atipicial-go", "wallet", "init", "--wallet", t.TempDir())
	})
	...
	t.Run("with account", func(t *testing.T) {
		...
		t.Run("missing acc name", func(t *testing.T) {
			e.RunWithError(t, "atipicial-go", "wallet", "init", "--wallet", walletPath, "--account")
		})
	...
	t.Run("with wallet config", func(t *testing.T) {
		...
		e.Run(t, "atipicial-go", "wallet", "init", "--wallet-config", configPath, "--account")
		w, err := wallet.NewWalletFromFile(walletPath)
		require.NoError(t, err)
		require.Equal(t, 1, len(w.Accounts))
	...
	t.Run("terminal escape codes", func(t *testing.T) {
		...
		e.Run(t, "atipicial-go", "wallet", "init", "--account",
			"--wallet", walletPath)
	...
	t.Run("CreateAccount", func(t *testing.T) {
		t.Run("stdin", func(t *testing.T) {
			e.RunWithError(t, "atipicial-go", "wallet", "create", "--wallet", "-")
		})
		t.Run("passwords mismatch", func(t *testing.T) {
			e.In.WriteString("testname\r")
			e.In.WriteString("testpass\r")
			e.In.WriteString("badpass\r")
			e.RunWithError(t, "atipicial-go", "wallet", "create", "--wallet", walletPath)
		})
		e.In.WriteString("testname\r")
		e.In.WriteString("testpass\r")
		e.In.WriteString("testpass\r")
		...
		t.Run("RemoveAccount", func(t *testing.T) {
			...
			e.Run(t, "atipicial-go", "wallet", "remove",
	...
	t.Run("Import", func(t *testing.T) {
		t.Run("WIF", func(t *testing.T) {
			t.Run("missing wallet", func(t *testing.T) {
				e.RunWithError(t, "atipicial-go", "wallet", "import")
			})
			...
			e.In.WriteString("qwerty\r")
			e.Run(t, "atipicial-go", "wallet", "import", "--wallet", walletPath,
				"--wif", priv.WIF())
			...
			t.Run("contract", func(t *testing.T) {
				...
				t.Run("good", func(t *testing.T) {
					...
					e.In.WriteString("qwerty\r")
					e.In.WriteString("qwerty\r")
					e.Run(t, "atipicial-go", "wallet", "import",
		...
		t.Run("EncryptedWIF", func(t *testing.T) {
			...
			require.NoError(t, err)
			require.NoError(t, acc.Encrypt("somepass", keys.AEP2ScryptParams()))

			t.Run("InvalidPassword", func(t *testing.T) {
				e.In.WriteString("password1\r")
				e.RunWithError(t, "atipicial-go", "wallet", "import", "--wallet", walletPath,
		...
		t.Run("EncryptedWIF with wallet config", func(t *testing.T) {
			...
			check := func(t *testing.T, configPass string, needUserPass bool) {
				acc, err := wallet.NewAccount()
				require.NoError(t, acc.Encrypt(pass, keys.AEP2ScryptParams()))
				...
				e.Run(t, "atipicial-go", "wallet", "import", "--wallet-config", configPath,
		...
		t.Run("Multisig", func(t *testing.T) {
			t.Run("missing wallet", func(t *testing.T) {
				e.RunWithError(t, "atipicial-go", "wallet", "import-multisig")
			})
			...
			cmd := []string{"atipicial-go", "wallet", "import-multisig",
				"--wallet", walletPath,
				"--min", "2"}
			...
			t.Run("existing account public key, no WIF", func(t *testing.T) {
				e.Run(t, "atipicial-go", "wallet", "import-multisig",
					"--wallet", walletPath,
					"--min", "2",
...
func TestWalletExport(t *testing.T) {
	...
	t.Run("missing wallet", func(t *testing.T) {
		e.RunWithError(t, "atipicial-go", "wallet", "export")
	})
	t.Run("invalid address", func(t *testing.T) {
		e.RunWithError(t, "atipicial-go", "wallet", "export",
	...
	t.Run("Encrypted", func(t *testing.T) {
		t.Run("good: no format", func(t *testing.T) {
			e.Run(t, "atipicial-go", "wallet", "export",
				"--wallet", testcli.ValidatorWallet, testcli.ValidatorAddr)
			line, err := e.Out.ReadString('\n')
			require.NoError(t, err)
			enc, err := keys.AEP2Encrypt(testcli.ValidatorPriv, "one", keys.ScryptParams{N: 2, R: 1, P: 1}) // these params used in validator wallet for better resources consumption
			require.NoError(t, err)
			require.Equal(t, enc, strings.TrimSpace(line))
		})
		t.Run("good: aep2", func(t *testing.T) {
			e.Run(t, "atipicial-go", "wallet", "export",
				"--wallet", testcli.ValidatorWallet, "--format", "aep2", testcli.ValidatorAddr)
			line, err := e.Out.ReadString('\n')
			require.NoError(t, err)
			enc, err := keys.AEP2Encrypt(testcli.ValidatorPriv, "one", keys.ScryptParams{N: 2, R: 1, P: 1}) // these params used in validator wallet for better resources consumption
			require.NoError(t, err)
...
func TestWalletClaimGas(t *testing.T) {
	...
	t.Run("missing wallet path", func(t *testing.T) {
		e.RunWithError(t, "atipicial-go", "wallet", "claim",
			"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
			"--address", testcli.TestWalletAccount)
	})
	t.Run("missing address", func(t *testing.T) {
		e.RunWithErrorCheck(t, `Required flag "address" not set`, "atipicial-go", "wallet", "claim",
			"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
	...
	t.Run("missing endpoint", func(t *testing.T) {
		e.In.WriteString("testpass\r")
		e.RunWithErrorCheck(t, `Required flag "rpc-endpoint" not set`, "atipicial-go", "wallet", "claim",
			"--wallet", testcli.TestWalletPath,
			"--address", testcli.TestWalletAccount)
	})
	...
	args := []string{
		...
		"--force",
		"ATC:" + testcli.TestWalletAccount + ":1000",
	...
	e.In.WriteString("testpass\r")
	e.Run(t, "atipicial-go", "wallet", "claim",
		"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
		"--wallet", testcli.TestWalletPath,
		"--address", testcli.TestWalletAccount,
		"--force")
...
func TestWalletImportDeployed(t *testing.T) {
	...
	t.Run("missing wallet", func(t *testing.T) {
		e.RunWithErrorCheck(t, `Required flag "contract" not set`, "atipicial-go", "wallet", "import-deployed", "--rpc-endpoint", "http://"+e.RPC.Addresses()[0])
	})
	t.Run("missing contract sh", func(t *testing.T) {
		e.RunWithErrorCheck(t, `Required flag "contract" not set`, "atipicial-go", "wallet", "import-deployed",
			"--wallet", walletPath, "--rpc-endpoint", "http://"+e.RPC.Addresses()[0])
	})
	t.Run("missing WIF", func(t *testing.T) {
		e.RunWithError(t, "atipicial-go", "wallet", "import-deployed",
			"--wallet", walletPath, "--contract", h.StringLE(), "--rpc-endpoint", "http://"+e.RPC.Addresses()[0])
	})
	t.Run("missing endpoint", func(t *testing.T) {
		e.In.WriteString("acc\rpass\rpass\r")
		e.RunWithErrorCheck(t, `Required flag "rpc-endpoint" not set`, "atipicial-go", "wallet", "import-deployed",
	...
	e.In.WriteString("acc\rpass\rpass\r")
	e.Run(t, "atipicial-go", "wallet", "import-deployed",
		"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
		"--wallet", walletPath, "--wif", priv.WIF(),
		"--contract", h.StringLE())
	...
	t.Run("Sign", func(t *testing.T) {
		...
		e.In.WriteString("pass\r")
		e.Run(t, "atipicial-go", "wallet", "aep17", "transfer",
			"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
			"--wallet", walletPath, "--from", contractAddr,
			"--force",
			"--to", privTo.Address(), "--token", "ATC", "--amount", "1")
		e.CheckTxPersisted(t)
...
func TestStripKeys(t *testing.T) {
	...
	e.RunWithError(t, "atipicial-go", "wallet", "strip-keys", "--wallet", walletPath, "something")
	e.RunWithError(t, "atipicial-go", "wallet", "strip-keys", "--wallet", walletPath+".bad")

	e.In.WriteString("no")
	e.Run(t, "atipicial-go", "wallet", "strip-keys", "--wallet", walletPath)
	...
	e.In.WriteString("y\r")
	e.Run(t, "atipicial-go", "wallet", "strip-keys", "--wallet", walletPath)
	e.Run(t, "atipicial-go", "wallet", "strip-keys", "--wallet", walletPath, "--force") // Does nothing effectively, but tests the force flag.
...
func TestOfflineSigning(t *testing.T) {
	...
	e.Run(t, "atipicial-go", "wallet", "strip-keys", "--wallet", walletPath, "--force")

	t.Run("1/1 multisig", func(t *testing.T) {
		args := []string{"atipicial-go", "wallet", "aep17", "transfer",
			"--rpc-endpoint", "http://" + e.RPC.Addresses()[0],
			"--wallet", walletPath,
			"--from", testcli.ValidatorAddr,
		...
		e.In.WriteString("one\r")
		e.Run(t, "atipicial-go", "wallet", "sign",
	...
	t.Run("simple signature", func(t *testing.T) {
		...
		e.RunWithError(t, "atipicial-go", "util", "sendtx", txPath)
		// But it requires no wallet at all.
		e.Run(t, "atipicial-go", "util", "sendtx",
			"--rpc-endpoint", "http://"+e.RPC.Addresses()[0],
			txPath)
	})
...
func TestWalletDump(t *testing.T) {
	...
	t.Run("missing wallet", func(t *testing.T) {
		e.RunWithError(t, "atipicial-go", "wallet", "dump")
	})
	cmd := []string{"atipicial-go", "wallet", "dump", "--wallet", testcli.TestWalletPath}
	e.Run(t, cmd...)
	...
	t.Run("with decrypt", func(t *testing.T) {
		...
		t.Run("good, from wallet config", func(t *testing.T) {
			...
			require.NoError(t, err)
			require.NoError(t, os.WriteFile(configPath, res, 0666))
			e.Run(t, "atipicial-go", "wallet", "dump", "--wallet-config", configPath)
			rawStr := strings.TrimSpace(e.Out.String())
			w := new(wallet.Wallet)
			require.NoError(t, json.Unmarshal([]byte(rawStr), w))
			require.Equal(t, 1, len(w.Accounts))
...
func TestWalletDumpKeys(t *testing.T) {
	e := testcli.NewExecutor(t, false)
	t.Run("missing wallet", func(t *testing.T) {
		e.RunWithError(t, "atipicial-go", "wallet", "dump-keys")
	})
	cmd := []string{"atipicial-go", "wallet", "dump-keys", "--wallet", testcli.ValidatorWallet}
...
// TestWalletConvert tests the conversion of the legacy wallet format to  wallet format.
func TestWalletConvert(t *testing.T) {
	tmpDir := t.TempDir()
	e := testcli.NewExecutor(t, false)

	outPath := filepath.Join(tmpDir, "wallet.json")
	cmd := []string{"atipicial-go", "wallet", "convert"}
	t.Run("missing wallet", func(t *testing.T) {
		e.RunWithErrorCheck(t, `Required flag "out" not set`, cmd...)
	})
	cmd = append(cmd, "--wallet", "testdata/testwallet_ATC2.json")
	...
	e.In.WriteString("one\r")
	e.In.WriteString("one\r")
	e.Run(t, "atipicial-go", "wallet", "convert",
		"--wallet", "testdata/testwallet_ATC2.json",
		"--out", outPath)

	actual, err := wallet.NewWalletFromFile(outPath)
	require.NoError(t, err)
	expected, err := wallet.NewWalletFromFile("testdata/testwallet_ATIPICIAL.json")
	require.NoError(t, err)
