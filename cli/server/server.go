...
import (
	...
	"github.com/atipicial/atipicial-go/internal/sdnotify"
	"github.com/atipicial/atipicial-go/pkg/config"
	"github.com/atipicial/atipicial-go/pkg/config/netmode"
	"github.com/atipicial/atipicial-go/pkg/consensus"
	...
	corestate "github.com/atipicial/atipicial-go/pkg/core/stateroot"
	...
	"github.com/atipicial/atipicial-go/pkg/services/metrics"
	"github.com/atipicial/atipicial-go/pkg/services/notary"
	"github.com/atipicial/atipicial-go/pkg/services/oracle"
	"github.com/atipicial/atipicial-go/pkg/services/rpcsrv"
	"github.com/atipicial/atipicial-go/pkg/services/stateroot"
...
func NewCommands() []*cli.Command {
	...
	return []*cli.Command{
		{
			Name:      "node",
			Usage:     "Start a AtipicialGo node",
			UsageText: "atipicial-go node [--config-path path] [-d] [-p/-m/-t] [--config-file file] [--force-timestamp-logs]",
			Action:    startServer,
			Flags:     cfgFlags,
		},
		{
			...
			Subcommands: []*cli.Command{
				{
					...
					UsageText: "atipicial-go db dump [-o file] [-s start] [-c count] [--config-path path] [-p/-m/-t] [--config-file file] [--force-timestamp-logs]",
					Action:    dumpDB,
				...
				},
				{
					...
					UsageText: "atipicial-go db dump-bin -o directory [-s start] [-c count] [--config-path path] [-p/-m/-t] [--config-file file] [--force-timestamp-logs]",
					Action:    dumpBin,
				...
				},
				{
					...
					UsageText: "atipicial-go db restore [-i file] [--dump] [-c count] [--config-path path] [-p/-m/-t] [--config-file file] [--force-timestamp-logs]",
					Action:    restoreDB,
				...
				},
				{
					...
					UsageText: "atipicial-go db reset --height height [--config-path path] [-p/-m/-t] [--config-file file] [--force-timestamp-logs]",
					Action:    resetDB,
...
func startServer(ctx *cli.Context) error {
	...
	setAtipicialGoVersion(config.Version)
	serv.Start()
