...
var generateWrapperCmd = &cli.Command{
	...
	UsageText: "atipicial-go contract generate-wrapper --manifest <file.json> --out <file.go> [--hash <hash>] [--config <config>]",
...
var generateRPCWrapperCmd = &cli.Command{
	...
	UsageText: "atipicial-go contract generate-rpcwrapper --manifest <file.json> --out <file.go> [--hash <hash>] [--config <config>]",
