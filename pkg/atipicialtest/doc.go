/*
Package atipicialtest contains a framework for automated contract testing.
...
execution can affect tests. See https://github.com/atipicial/atipicial-go/issues/3120 for details.
...
In case `go test` coverage is wanted DISABLE_ATCTEST_COVER=1 variable can be set.
