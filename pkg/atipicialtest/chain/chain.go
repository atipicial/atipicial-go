...
// the same time).
func NewSingle(t testing.TB) (*core.Blockchain, atipicialtest.Signer) {
	return NewSingleWithCustomConfig(t, nil)
}

// NewSingleWithCustomConfig is similar to NewSingle, but allows to override the
// default configuration.
func NewSingleWithCustomConfig(t testing.TB, f func(*config.Blockchain)) (*core.Blockchain, atipicialtest.Signer) {
...
func NewSingleWithCustomConfigAndStore(t testing.TB, f func(cfg *config.Blockchain), st storage.Store, run bool) (*core.Blockchain, atipicialtest.Signer) {
...
func NewSingleWithOptions(t testing.TB, options *Options) (*core.Blockchain, atipicialtest.Signer) {
	if options == nil {
		options = &Options{}
	}
	...
	return bc, atipicialtest.NewMultiSigner(committeeAcc)
}
...
func NewMulti(t testing.TB) (*core.Blockchain, atipicialtest.Signer, atipicialtest.Signer) {
	return NewMultiWithCustomConfig(t, nil)
}

// NewMultiWithCustomConfig is similar to NewMulti, except it allows to override the
// default configuration.
func NewMultiWithCustomConfig(t testing.TB, f func(*config.Blockchain)) (*core.Blockchain, atipicialtest.Signer, atipicialtest.Signer) {
...
// responsibility to do that before using the chain and
// to properly Close the chain when done.
func NewMultiWithCustomConfigAndStore(t testing.TB, f func(*config.Blockchain), st storage.Store, run bool) (*core.Blockchain, atipicialtest.Signer, atipicialtest.Signer) {
...
// committee members. Otherwise, it does not differ much from NewSingle. The
// second value returned contains the validators Signer, the third -- the committee one.
func NewMultiWithOptions(t testing.TB, options *Options) (*core.Blockchain, atipicialtest.Signer, atipicialtest.Signer) {
...
func NewMultiWithCustomConfigAndStoreNoCheck(t testing.TB, f func(*config.Blockchain), st storage.Store) (*core.Blockchain, atipicialtest.Signer, atipicialtest.Signer, error) {
...
func NewMultiWithOptionsNoCheck(t testing.TB, options *Options) (*core.Blockchain, atipicialtest.Signer, atipicialtest.Signer, error) {
	if options == nil {
		options = &Options{}
	}
	...
	return bc, atipicialtest.NewMultiSigner(multiValidatorAcc...), atipicialtest.NewMultiSigner(multiCommitteeAcc...), err
}
