...
// The only method omitted is onAEP17Payment which can only be called
...
// OnAEP17PaymentData is the data set that is accepted by the notary contract
// onAEP17Payment handler. It's mandatory for GAS transfers to this contract.
type OnAEP17PaymentData struct {
...
// OnAEP17PaymentData have to implement stackitem.Convertible interface to be
// compatible with emit package.
var _ = stackitem.Convertible(&OnAEP17PaymentData{})
...
func (d *OnAEP17PaymentData) ToStackItem() (stackitem.Item, error) {
...
func (d *OnAEP17PaymentData) FromStackItem(si stackitem.Item) error {
