...
func TestOnAEP17PaymentData_Convertible(t *testing.T) {
	t.Run("non-empty owner", func(t *testing.T) {
		d := &OnAEP17PaymentData{
			Account: &util.Uint160{1, 2, 3},
			Till:    123,
		}
		testserdes.ToFromStackItem(t, d, new(OnAEP17PaymentData))
	})
...
func TestOnAEP17PaymentDataToStackItem(t *testing.T) {
	testCases := map[string]struct {
		data     *OnAEP17PaymentData
...
func TestOnAEP17PaymentData_FromStackItem(t *testing.T) {
