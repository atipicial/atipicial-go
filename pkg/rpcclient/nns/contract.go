...
// This is Atipicial  NNS contract wrapper, the source code of the contract can be found here:
// https://github.com/atipicial-project/non-native-contracts/blob/8d72b92e5e5705d763232bcc24784ced0fb8fc87/src/NameService/NameService.cs
package nns
...
// Contract provides full AtipicialNameService interface, both safe and state-changing methods.
...
func NewReader(invoker Invoker, hash util.Uint160) *ContractReader {
	return &ContractReader{*aep11.NewNonDivisibleReader(invoker, hash), invoker, hash}
}

// New creates an instance of Contract using provided contract hash and the given Actor.
func New(actor Actor, hash util.Uint160) *Contract {
	var aep11ndt = aep11.NewNonDivisible(actor, hash)
	return &Contract{ContractReader{aep11ndt.NonDivisibleReader, actor, hash}, aep11ndt.BaseWriter, actor, hash}
}
...
func (c *Contract) Update(aef []byte, manifest string) (util.Uint256, uint32, error) {
	return c.actor.SendCall(c.hash, "update", aef, manifest)
}

// UpdateTransaction creates a transaction invoking `update` method of the contract.
// This transaction is signed, but not sent to the network, instead it's
// returned to the caller.
func (c *Contract) UpdateTransaction(aef []byte, manifest string) (*transaction.Transaction, error) {
	return c.actor.MakeCall(c.hash, "update", aef, manifest)
}
...
func (c *Contract) UpdateUnsigned(aef []byte, manifest string) (*transaction.Transaction, error) {
	return c.actor.MakeUnsignedCall(c.hash, "update", nil, aef, manifest)
}
