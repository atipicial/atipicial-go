...
// to remote ATC RPC nodes. Client is thread-safe and can be used from
// multiple goroutines.
type Client struct {
	cli      *http.Client
	endpoint *url.URL
	...
	ctxCancel func()
	opts      Options
	requestF  func(*atipicialrpc.Request) (*atipicialrpc.Response, error)
...
// and native ATC, GAS and Policy contracts scripthashes. This method should be
...
func (c *Client) performRequest(method string, p []any, v any) error {
	if p == nil {
		p = []any{} // atipicial-project/atipicial-modules#742
	}
	var r = atipicialrpc.Request{
...
func (c *Client) makeHTTPRequest(r *atipicialrpc.Request) (*atipicialrpc.Response, error) {
	var (
		buf = new(bytes.Buffer)
		raw = new(atipicialrpc.Response)
	)
