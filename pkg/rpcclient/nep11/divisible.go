...
// DivisibleReader is a reader interface for divisible AEP-11 contract.
type DivisibleReader struct {
	BaseReader
}

// DivisibleWriter is a state-changing interface for divisible AEP-11 contract.
...
// Divisible is a full  reader interface for divisible AEP-11 contract.
...
// OwnerOfExpanded uses the same AEP-11 method as OwnerOf, but can be useful if
