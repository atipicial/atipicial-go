/*
Package aep24 provides RPC wrappers for AEP-24 contracts.
...
Refer to the aep11 package for basic NFT functionalities, while aep24 handles
...
// RoyaltyReader represents safe (read-only) methods of AEP-24 token. It can be
// used to query data about royalties.
type RoyaltyReader struct {
	invoker aeptoken.Invoker
	hash    util.Uint160
}

// NewRoyaltyReader returns a new RoyaltyReader instance.
func NewRoyaltyReader(invoker aeptoken.Invoker, hash util.Uint160) *RoyaltyReader {
