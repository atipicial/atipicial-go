...
const txMoveAtipicialVerbose = `{"blockhash":"0x88c1cbf68695f73fb7b7d185c0037ffebdf032327488ebe65e0533d269e7de9b","confirmations":15,"blocktime":1626251469001,"vmstate":"HALT","hash":"0xf01080c50f3198f5a539c4a06d024f1b8bdc2a360a215fa7e2488f79a56d501a","size":488,"version":0,"nonce":2,"sender":"NVTiAjNgagDkTr5HTzDmQP9kPwPHN5BgVq","sysfee":"11000000","netfee":"4421900","validuntilblock":1200,"attributes":[],"signers":[{"account":"0x3f223f6da778e805d1b9b479906c0e8c1ee8b968","scopes":"CalledByEntry"}],"script":"CwIY3fUFDBTunqIsJ+NL0BSPxBCOCPdOj1BIsgwUaLnoHowObJB5tLnRBeh4p20/Ij8UwB8MCHRyYW5zZmVyDBT1Y+pAvCg9TQ4FxI6jBbPyoHNA70FifVtSOQ==","witnesses":[{"invocation":"","verification":"EwwhAhA6f33QFlWFl/eWDSfFFqQ5T9loueZRVetLAT5AQEBuDCECp7xV/oaE4BGXaNEEujB5W9zIZhnoZK3SYVZyPtGFzWIMIQKzYiv0AXvf4xfFiu1fTHU/IGt9uJYEb6fXdLvEv3+NwgwhA9kMB99j5pDOd5EuEKtRrMlEtmhgI3tgjE+PgwnnHuaZFEGe0Nw6"}]}`
...
func getTxMoveAtipicial() *result.TransactionOutputRaw {
	b1 := getResultBlock1()
	txBin, err := base64.StdEncoding.DecodeString(base64TxMoveAtipicial)
	if err != nil {
		panic(err)
	}
...
// (see https://docs.atipicial.org/docs/en-us/reference/rpc/latest-version/api.html)
	...
	"getcontractstate": {
		{
			...
			serverResponse: `{"id":1,"jsonrpc":"2.0","result":{"id":0,"aef":{"magic":860243278,"compiler":"atipicial-go-3.0","script":"","checksum":2512077441},"manifest":{"name":"Test","abi":{"methods":[],"events":[]},"groups":[],"features":{},"permissions":[],"trusts":[],"supportedstandards":[],"safemethods":[],"extra":null},"hash":"0x1b4357bff5a01bdf2a6581247cf9ed1e24629176"}}`,
			result: func(c *Client) any {
	...
	"getaep11balances": {
		{
			...
			invoke: func(c *Client) (any, error) {
				...
				return c.GetAEP11Balances(hash)
			},
			...
			result: func(c *Client) any {
				...
				return &result.AEP11Balances{
					Balances: []result.AEP11AssetBalance{{
						Asset:    hash,
						Decimals: 42,
						Name:     "Contract",
						Symbol:   "SOME",
						Tokens: []result.AEP11TokenBalance{{
							ID:          "abcdef",
							Amount:      "1",
							LastUpdated: 251604,
						}},
	...
	"getaep17balances": {
		{
			...
			invoke: func(c *Client) (any, error) {
				...
				return c.GetAEP17Balances(hash)
			},
	...
	"getaep11properties": {
		{
			...
			invoke: func(c *Client) (any, error) {
				...
				return c.GetAEP11Properties(hash, []byte("abcdef"))
	...
	"getaep11transfers": {
		{
			...
			invoke: func(c *Client) (any, error) {
				...
				return c.GetAEP11Transfers(hash, nil, nil, nil, nil)
			},
			...
			result: func(c *Client) any {
				...
				return &result.AEP11Transfers{
					Sent: []result.AEP11Transfer{},
					Received: []result.AEP11Transfer{
						{
	...
	"getaep17transfers": {
		{
			...
			invoke: func(c *Client) (any, error) {
				...
				return c.GetAEP17Transfers(hash, nil, nil, nil, nil)
			},
	...
	"getpeers": {
		{
			...
			serverResponse: `{"id":1,"jsonrpc":"2.0","result":{"unconnected":[{"address":"172.200.0.1","port":20333}],"connected":[{"address":"127.0.0.1","port":20335, "useragent":"/ATIPICIAL-GO:0.106.2/", "lastknownheight":1000}],"bad":[{"address":"172.200.0.254","port":20332}]}}`,
			result: func(c *Client) any {
					...
					Connected: result.Peers{
						{
							Address:         "127.0.0.1",
							Port:            20335,
							UserAgent:       "/ATIPICIAL-GO:0.106.2/",
	...
	"getrawtransaction": {
		{
			...
			serverResponse: `{"id":1,"jsonrpc":"2.0","result":"` + base64TxMoveAtipicial + `"}`,
			result: func(c *Client) any {
				tx := getTxMoveAtipicial()
		...
		},
		{
			...
			serverResponse: `{"id":1,"jsonrpc":"2.0","result":` + txMoveAtipicialVerbose + `}`,
			result: func(c *Client) any {
				return getTxMoveAtipicial()
			},
		},
	},
	"getstateroot": {
	...
	"getversion": {
		{
			...
			serverResponse: `{"id":1,"jsonrpc":"2.0","result":{"tcpport":20332,"wsport":20342,"nonce":2153672787,"useragent":"/ATIPICIAL-GO:0.73.1-pre-273-ge381358/", "protocol": {"network": 2, "hardforks": {}}, "application": {"saveinvocations": true,"keeponlylateststate": true,"removeuntraceableblocks": true}, "rpc": {"maxiteratorresultitems": 100, "sessionenabled": true}}`,
			result: func(c *Client) any {
				return &result.Version{
					TCPPort:   uint16(20332),
					WSPort:    uint16(20342),
					Nonce:     2153672787,
					UserAgent: "/ATIPICIAL-GO:0.73.1-pre-273-ge381358/",
...
var rpcClientErrorCases = map[string][]rpcClientErrorCase{
	`{"jsonrpc":"2.0","id":1,"result":{"name":"name","bad":42}}`: {
		{
			name: "getaep11properties_unmarshalling_error",
			invoke: func(c *Client) (any, error) {
				return c.GetAEP11Properties(util.Uint160{}, []byte{})
			},
		},
	},
	...
	`{"id":1,"jsonrpc":"2.0","error":{"code":-32602,"message":"Invalid params"}}`: {
		...
		{
			name: "getaep11balances_invalid_params_error",
			invoke: func(c *Client) (any, error) {
				return c.GetAEP11Balances(util.Uint160{})
			},
		},
		{
			name: "getaep17balances_invalid_params_error",
			invoke: func(c *Client) (any, error) {
				return c.GetAEP17Balances(util.Uint160{})
			},
		},
		{
			name: "getaep11properties_invalid_params_error",
			invoke: func(c *Client) (any, error) {
				return c.GetAEP11Properties(util.Uint160{}, []byte{})
			},
		},
		{
			name: "getaep11transfers_invalid_params_error",
			invoke: func(c *Client) (any, error) {
				return c.GetAEP11Transfers(util.Uint160{}, nil, nil, nil, nil)
			},
		},
		{
			name: "getaep17transfers_invalid_params_error",
			invoke: func(c *Client) (any, error) {
				return c.GetAEP17Transfers(util.Uint160{}, nil, nil, nil, nil)
			},
		},
		{
			name: "getaep17transfers_invalid_params_error 2",
			invoke: func(c *Client) (any, error) {
				var stop uint64
				return c.GetAEP17Transfers(util.Uint160{}, nil, &stop, nil, nil)
			},
		},
		{
			name: "getaep17transfers_invalid_params_error 3",
			invoke: func(c *Client) (any, error) {
				var start uint64
				var limit int
				return c.GetAEP17Transfers(util.Uint160{}, &start, nil, &limit, nil)
			},
		},
		{
			name: "getaep17transfers_invalid_params_error 4",
			invoke: func(c *Client) (any, error) {
				var start, stop uint64
				var page int
				return c.GetAEP17Transfers(util.Uint160{}, &start, &stop, nil, &page)
			},
		},
		{
	...
	`{}`: {
		...
		{
			name: "getaep11balances_unmarshalling_error",
			invoke: func(c *Client) (any, error) {
				return c.GetAEP11Balances(util.Uint160{})
			},
		},
		{
			name: "getaep17balances_unmarshalling_error",
			invoke: func(c *Client) (any, error) {
				return c.GetAEP17Balances(util.Uint160{})
			},
		},
		{
			name: "getaep11transfers_unmarshalling_error",
			invoke: func(c *Client) (any, error) {
				return c.GetAEP11Transfers(util.Uint160{}, nil, nil, nil, nil)
			},
		},
		{
			name: "getaep17transfers_unmarshalling_error",
			invoke: func(c *Client) (any, error) {
				return c.GetAEP17Transfers(util.Uint160{}, nil, nil, nil, nil)
			},
		},
...
func newTestAEF(script []byte) aef.File {
	var ne aef.File
	ne.Magic = aef.Magic
	ne.Compiler = "atipicial-go-3.0"
	ne.Script = script
