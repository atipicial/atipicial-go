...
func TestUpdateTransaction(t *testing.T) {
	...
	for name, fn := range map[string]func(aef, mf []byte, data any) (any, error){
		"UpdateTransaction": func(aef, mf []byte, data any) (any, error) {
			return tok.UpdateTransaction(aef, mf, data)
		},
		"UpdateUnsigned": func(aef, mf []byte, data any) (any, error) {
			return tok.UpdateUnsigned(aef, mf, data)
		},
	} {
