...
import (
	...
	sccontext "github.com/atipicial/atipicial-go/pkg/smartcontract/context"
...
func ExampleActor() {
	...
	// ATC then [atipicial] package can accept our Actor and allow to easily use ATC methods.
	atipicialContract := atipicial.New(a)
	balance, _ := atipicialContract.BalanceOf(a.Sender())
	_ = balance
