...
func (o *Oracle) PostPersist(ic *interop.Context) error {
	...
	for i := range reward {
		o.GAS.MintDeferrable(ic, nodes[i].GetScriptHash(), &reward[i], false, func() {}) // no onAEP17Payment call => no source of asynchronous execution.
	}
...
func (o *Oracle) Initialize(ic *interop.Context, hf *config.Hardfork, newMD *interop.HFSpecificContractMD) error {
	...
	default:
		...
		if orc != nil && *orc != nil {
			...
			(*orc).UpdateNativeContract(newMD.AEF.Script, o.GetOracleResponseScript(),
				o.Hash, md.MD.Offset)
		}
	}
...
func (o *Oracle) RequestInternal(ic *interop.Context, url string, filter *string, cb string, userData stackitem.Item, gas *big.Int) error {
	...
	o.GAS.MintDeferrable(ic, o.Hash, gas, false, func() {}) // no onAEP17Payment call => no source of asynchronous execution.
