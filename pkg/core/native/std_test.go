...
import (
	...
	base58atipicialgo "github.com/atipicial/atipicial-go/pkg/encoding/base58"
...
func TestStdLibEncodeDecode(t *testing.T) {
	...
	// Source C# implementation: https://github.com/atipicial-project/atipicial/blob/216c39eddd03de2cb1f6f8aa5b3c19be60606f27/tests/Atipicial.UnitTests/SmartContract/Native/UT_StdLib.cs#s#L417-L418
	...
	encoded58Check := base58atipicialgo.CheckEncode(original)
	ic := &interop.Context{VM: vm.New()}
	var actual stackitem.Item
...
func TestStd_StrLen(t *testing.T) {
	...
	// These tests are taken from https://github.com/atipicial-project/atipicial/pull/2854/files.
	check(t, 1, "🦆")
	check(t, 1, "ã")
	check(t, 1, "a")
