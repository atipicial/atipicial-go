...
// TestKeccak256_Compat is a C# node compatibility test with data taken from https://github.com/Jim8y/atipicial/blob/560d35783e428d31e3681eaa7ee9ed00a8a50d09/tests/Atipicial.UnitTests/SmartContract/Native/UT_CryptoLib.cs#L340
...
func TestMurmur32(t *testing.T) {
	...
	t.Run("good", func(t *testing.T) {
		...
		// https://github.com/atipicial-project/atipicial/blob/2a64c1cc809d1ff4b3a573c7c22bffbbf69a738b/tests/atipicial.UnitTests/Cryptography/UT_Murmur32.cs#L18
...
func TestCryptolib_ScalarFromBytes_Compat(t *testing.T) {
	...
	} // R2 Scalar representation taken from the https://github.com/atipicial-project/Atipicial.Cryptography.BLS12_381/blob/844bc3a4f7d8ba2c545ace90ca124f8ada4c8d29/src/Atipicial.Cryptography.BLS12_381/ScalarConstants.cs#L55
