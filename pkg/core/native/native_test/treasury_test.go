...
func newTreasuryClient(t *testing.T) *atipicialtest.ContractInvoker {
...
func newCustomTreasuryClient(t *testing.T, f func(cfg *config.Blockchain)) *atipicialtest.ContractInvoker {
...
func TestTreasury_OnAEP17Payment(t *testing.T) {
