...
func blsPointAdd(a, b blsPoint) (blsPoint, error) {
	...
	case *bls12381.GT:
		...
		switch y := b.point.(type) {
		case *bls12381.GT:
			// It's multiplication, see https://github.com/atipicial-project/Atipicial.Cryptography.BLS12_381/issues/4.
			resGT.Mul(x, y)
		default:
			err = fmt.Errorf("add: inconsistent bls12381 point types: %T and %T", x, y)
		}
...
func blsPointMul(a blsPoint, alphaBi *big.Int) (blsPoint, error) {
	...
	case *bls12381.GT:
		...
		// https://github.com/atipicial-project/Atipicial.Cryptography.BLS12_381/blob/844bc3a4f7d8ba2c545ace90ca124f8ada4c8d29/src/Atipicial.Cryptography.BLS12_381/Gt.cs#L102
