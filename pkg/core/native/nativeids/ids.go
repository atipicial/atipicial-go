...
const (
	...
	// AtipicialCoin is an ID of native AtipicialCoin contract.
	AtipicialCoin int32 = -5
	// AtipicialDollar is an ID of native AtipicialDollar contract.
	AtipicialDollar int32 = -6
