...
type Header struct {
	...
	// It's AtipicialGo-specific, and is not a part of a standard Atipicial  header,
	...
	// AtipicialGo-specific extension of the protocol.
