...
// verify proofs on the Atipicial chain:
// https://github.com/atipicial/atipicial-go/blob/91c928e8d35164055e5b2e8efbc898440cc2b486/examples/zkp/cubic_circuit/README.md
package zkpbinding
...
type Config struct {
	...
	// parameters of which will be used to generate Verifier Atipicial smart contract.
...
const (
	...
	// changes using AtipicialGo compiler, deployed to the Atipicial chain and invoked. The
	...
	goVerificationTmpl = `//Code generated by atipicial-go zkpbinding.GenerateVerifier; DO NOT EDIT.

// Package main contains verification smart contract that uses Atipicial BLS12-381
...
//
// Use AtipicialGo smart contract compiler to compile this contract:
// https://github.com/atipicial/atipicial-go/blob/master/docs/compiler.md#compiling.
// You will need to create contract YAML configuration file and proper go.mod and
// go.sum files required for compilation. Please, refer to the AtipicialGo ZKP example
// to see how to verify proofs via the Verifier contract:
// https://github.com/atipicial/atipicial-go/tree/master/examples/zkp/cubic_circuit.
package main
...
sourceurl: https://github.com/atipicial/atipicial-go/
supportedstandards: []`
...
require github.com/atipicial/atipicial-go/pkg/interop v0.0.0-20241223145456-80e18222bca2
`

	// verifyGosum is a standard go.sum file needed for contract compilation.
	verifyGosum = `github.com/atipicial/atipicial-go/pkg/interop v0.0.0-20241223145456-80e18222bca2 h1:4Bfi6A1kPpaTDuwbDVc6x+R4WXgoNN9wIq6XobDlXHs=
github.com/atipicial/atipicial-go/pkg/interop v0.0.0-20241223145456-80e18222bca2/go.mod h1:kVLzmbeJJdbIPF2bUYhD8YppIiLXnRQj5yqNZvzbOL0=
`
)
...
// GenerateVerifier generates a Verifier smart contract written in Go for Atipicial
...
// any additional changes using AtipicialGo compiler, deployed to the Atipicial chain and
