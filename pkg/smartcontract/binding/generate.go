...
func {{.Name}}({{range $index, $arg := .Arguments -}}
	...
	return atipicialgointernal.CallWithToken(Hash, "{{ .NameABI }}", int(contract.{{ .CallFlag }})
		{{- range $arg := .Arguments -}}, {{.Name}}{{end}}).({{ .ReturnType }})
	{{- else -}} {
	atipicialgointernal.CallWithTokenNoRet(Hash, "{{ .NameABI }}", int(contract.{{ .CallFlag }})
...
{{- end -}}
// Code generated by atipicial-go contract generate-wrapper --manifest <file.json> --out <file.go> [--hash <hash>] [--config <config>]; DO NOT EDIT.
...
func Generate(cfg Config) error {
	...
	ctr.Imports = append(ctr.Imports, "github.com/atipicial/atipicial-go/pkg/interop/contract")
	if ctr.Hash != "" {
		ctr.Imports = append(ctr.Imports, "github.com/atipicial/atipicial-go/pkg/interop/atipicialgointernal")
	}
...
func scTypeToGo(name string, typ smartcontract.ParamType, cfg *Config) (string, string) {
	...
	case smartcontract.Hash160Type:
		return "interop.Hash160", "github.com/atipicial/atipicial-go/pkg/interop"
	case smartcontract.Hash256Type:
		return "interop.Hash256", "github.com/atipicial/atipicial-go/pkg/interop"
	case smartcontract.PublicKeyType:
		return "interop.PublicKey", "github.com/atipicial/atipicial-go/pkg/interop"
	case smartcontract.SignatureType:
		return "interop.Signature", "github.com/atipicial/atipicial-go/pkg/interop"
