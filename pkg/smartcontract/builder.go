...
// things that can be done in AtipicialVM. This hardly can be expressed in an API like
// this, so if you need more than that and if you're ready to work with bare
// AtipicialVM instructions please refer to [emit] and [opcode] packages.
type Builder struct {
	bw *io.BufBinWriter
}
...
// This pattern is pretty common, AEP-11 or AEP-17 'transfer' methods do exactly
// that as well as ATC's 'vote'. The ASSERT then allow to simplify transaction
