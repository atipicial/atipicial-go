...
func (p *Parameter) UnmarshalJSON(data []byte) (err error) {
	...
	case ArrayType:
		// https://github.com/atipicial-project/atipicial/blob/3d59ecca5a8deb057bdad94b3028a6d5e25ac088/atipicial/Network/RPC/RpcServer.cs#L67
		var rs []Parameter
...
// string in atipicial-go-specific format. It is intended to be used in user-facing
