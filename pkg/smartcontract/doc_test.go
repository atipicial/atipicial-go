...
func ExampleBuilder() {
	...
	b.InvokeMethod(atipicial.Hash, "transfer", a.Sender(), util.Uint160{0xff}, 1, nil)
	b.InvokeMethod(atipicial.Hash, "vote", pKey)
	script, _ := b.Script()
	...
	b.InvokeWithAssert(atipicial.Hash, "transfer", a.Sender(), util.Uint160{0x70}, 1, nil)
	b.InvokeWithAssert(gas.Hash, "transfer", a.Sender(), util.Uint160{0x71}, 100000, []byte("data"))
	b.InvokeWithAssert(atipicial.Hash, "transfer", a.Sender(), util.Uint160{0x72}, 1, nil)
	script, _ = b.Script()
