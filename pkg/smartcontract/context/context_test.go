...
import (
	...
	"github.com/atipicial/atipicial-go/pkg/core/interop/crypto"
...
func TestParameterContext_AddSignatureSimpleContract(t *testing.T) {
	...
	t.Run("invalid contract", func(t *testing.T) {
		c := NewParameterContext("Atipicial.Core.ContractTransaction", netmode.UnitTestNet, tx)
		ctr := &wallet.Contract{
...
func TestGetCompleteTransactionForNonTx(t *testing.T) {
	c := NewParameterContext("Atipicial.Network.P2P.Payloads.Block", netmode.UnitTestNet, verifStub{})
...
func TestParameterContext_MarshalJSON(t *testing.T) {
	...
	expected := &ParameterContext{
		Type:       "Atipicial.Core.ContractTransaction",
