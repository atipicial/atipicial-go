...
import (
	...
	"github.com/atipicial/atipicial-go/pkg/crypto"
...
const TransactionType = "Atipicial.Network.P2P.Payloads.Transaction"

// compatTransactionType is the old, 2.x type used for transactions.
const compatTransactionType = "Atipicial.Core.ContractTransaction"
