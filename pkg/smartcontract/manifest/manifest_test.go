...
// Test vectors are taken from the main ATC repo
// https://github.com/atipicial-project/atipicial/blob/master/tests/atipicial.UnitTests/SmartContract/Manifest/UT_ContractManifest.cs#L10
...
func TestIsValid(t *testing.T) {
	...
	m.SupportedStandards = append(m.SupportedStandards, "AEP-17")
...
func TestManifestToStackItem(t *testing.T) {
	...
	t.Run("full", func(t *testing.T) {
		...
		expected := &Manifest{
			...
			SupportedStandards: []string{"AEP-17"},
	...
	t.Run("compat", func(t *testing.T) {
		// Compatibility test with AtipicialC#, see https://github.com/atipicial-project/atipicial/pull/2948.
...
func TestManifest_ToSCParameter(t *testing.T) {
	...
	require.Equal(t, smartcontract.Parameter{Type: smartcontract.ArrayType, Value: []smartcontract.Parameter{
		...
		{Type: smartcontract.ArrayType, Value: []smartcontract.Parameter{ // SupportedStandards.
			{Type: smartcontract.StringType, Value: "AEP-17"},
		}},
...
func TestExtraToStackItem(t *testing.T) {
	testCases := []struct {
			...
			`[1,"array",{"d":"z","a":"x","c":"y","b":3}]`},
		{
			...
			`{"Author":"ATCZEN","Description":"ATC\u0027s First Inscriptions Meta Protocol","Deployment":"{\"p\":\"atipicialz-20\",\"op\":\"deploy\",\"tick\":\"atipicialz\",\"max\":\"21000000\",\"lim\":\"1000\"}"}`,
			`{"Author":"ATCZEN","Description":"ATC\u0027s First Inscriptions Meta Protocol","Deployment":"{\u0022p\u0022:\u0022atipicialz-20\u0022,\u0022op\u0022:\u0022deploy\u0022,\u0022tick\u0022:\u0022atipicialz\u0022,\u0022max\u0022:\u002221000000\u0022,\u0022lim\u0022:\u00221000\u0022}"}`,
		},
	}
...
func TestManifest_IsStandardSupported(t *testing.T) {
	m := &Manifest{
		SupportedStandards: []string{AEP17StandardName, AEP27StandardName, AEP26StandardName},
	}
	for _, st := range m.SupportedStandards {
		require.True(t, m.IsStandardSupported(st))
	}
	require.False(t, m.IsStandardSupported(AEP11StandardName))
