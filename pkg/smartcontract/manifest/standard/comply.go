...
var checks = map[string][]extendedStandard{
	manifest.AEP11StandardName: {
		extendedStandard{
			extendedName: "non-divisible",
			Standard:     Aep11NonDivisible,
		},
		extendedStandard{
			extendedName: "divisible",
			Standard:     Aep11Divisible,
		}},
	manifest.AEP17StandardName: {{Standard: Aep17}},
	manifest.AEP22StandardName: {{Standard: Aep22}},
	manifest.AEP26StandardName: {{Standard: Aep26}},
	manifest.AEP27StandardName: {{Standard: Aep27}},
	manifest.AEP24StandardName: {{Standard: Aep24}},
	manifest.AEP24Payable:      {{Standard: Aep24Payable}},
	manifest.AEP29StandardName: {{Standard: Aep29}},
	manifest.AEP30StandardName: {{Standard: Aep30}},
	manifest.AEP31StandardName: {{Standard: Aep31}},
}
