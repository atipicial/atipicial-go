...
const (
	...
	// AEP11StandardName represents the name of AEP-11 smartcontract standard.
	AEP11StandardName = "AEP-11"
	// AEP17StandardName represents the name of AEP-17 smartcontract standard.
	AEP17StandardName = "AEP-17"
	// AEP22StandardName represents the name of AEP-22 smartcontract standard for upgradeable contracts.
	AEP22StandardName = "AEP-22"
	// AEP24StandardName represents the name of the AEP-24 smart contract standard for NFT royalties.
	AEP24StandardName = "AEP-24"
	// AEP24Payable represents the name of the contract interface for handling royalty payments in accordance
	// with the AEP-24 standard.
	AEP24Payable = "AEP-24-Payable"
	// AEP26StandardName represents the name of AEP-26 smartcontract standard describing onAEP11Payment callback.
	AEP26StandardName = "AEP-26"
	// AEP27StandardName represents the name of AEP-27 smartcontract standard describing onAEP17Payment callback.
	AEP27StandardName = "AEP-27"
	// AEP29StandardName represents the name of AEP-29 smartcontract standard describing _deploy method specification.
	AEP29StandardName = "AEP-29"
	// AEP30StandardName represents the name of AEP-30 smartcontract standard describing verify method specification.
	AEP30StandardName = "AEP-30"
	// AEP31StandardName represents the name of AEP-31 smartcontract standard for destroyable contracts.
	AEP31StandardName = "AEP-31"
