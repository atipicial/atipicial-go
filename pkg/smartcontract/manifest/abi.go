...
const (
	...
	// MethodOnAEP17Payment is the name of the method which is called when contract receives AEP-17 tokens.
	MethodOnAEP17Payment = "onAEP17Payment"

	// MethodOnAEP11Payment is the name of the method which is called when contract receives AEP-11 tokens.
	MethodOnAEP11Payment = "onAEP11Payment"
)
