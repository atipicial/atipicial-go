...
// ParseAEP11Transfer parses a standard non-divisible AEP-11 transfer script
...
func ParseAEP11Transfer(script []byte) (util.Uint160, util.Uint160, []byte, PushedItem, error) {
	ctx := NewContext(script, 0)
	h, to, tokenID, data, err := GetAEP11TransferFromContext(ctx)
	if err != nil {
		return h, to, tokenID, data, fmt.Errorf("failed to parse AEP-11 transfer: %w", err)
	}
...
// GetAEP11TransferFromContext parses a standard non-divisible AEP-11 transfer
...
func GetAEP11TransferFromContext(ctx *Context) (util.Uint160, util.Uint160, []byte, PushedItem, error) {
	var (
		h, to   util.Uint160
		tokenID []byte
		data    PushedItem
...
// ParseAEP11TransferD parses a standard divisible AEP-11 transfer script with
...
// provided).
func ParseAEP11TransferD(script []byte) (util.Uint160, util.Uint160, util.Uint160, *big.Int, []byte, PushedItem, error) {
	ctx := NewContext(script, 0)
	h, from, to, amount, tokenID, data, err := GetAEP11TransferDFromContext(ctx)
	if err != nil {
		return h, from, to, amount, tokenID, data, fmt.Errorf("failed to parse AEP-11 transfer: %w", err)
	}
	if ctx.NextIP() < len(ctx.prog) {
		if err = GetASSERTFromContext(ctx); err != nil {
...
// GetAEP11TransferDFromContext parses a standard divisible AEP-11 transfer
...
func GetAEP11TransferDFromContext(ctx *Context) (util.Uint160, util.Uint160, util.Uint160, *big.Int, []byte, PushedItem, error) {
	var (
...
// ParseAEP17Transfer parses a standard AEP-17 transfer script with optional
...
func ParseAEP17Transfer(script []byte) (util.Uint160, util.Uint160, util.Uint160, *big.Int, PushedItem, error) {
	ctx := NewContext(script, 0)
	h, from, to, amount, data, err := GetAEP17TransferFromContext(ctx)
	if err != nil {
		return h, from, to, amount, data, fmt.Errorf("failed to parse AEP-17 transfer: %w", err)
	}
	if ctx.NextIP() < len(ctx.prog) {
		if err = GetASSERTFromContext(ctx); err != nil {
...
// GetAEP17TransferFromContext parses a standard AEP-17 transfer script. It
...
func GetAEP17TransferFromContext(ctx *Context) (util.Uint160, util.Uint160, util.Uint160, *big.Int, PushedItem, error) {
	var (
		h, from, to util.Uint160
		amount      *big.Int
		data        PushedItem
