...
type (
	...
	ServerConfig struct {
		...
		// ModeTestNet Atipicial test network.
		// ModeMainNet Atipicial main network.
		Net netmode.Magic
		...
		AtipicialFsBlockFetcherCfg config.AtipicialFsBlockFetcher
		// AtipicialFsStateFetcherCfg is the statefetcher module configuration.
		AtipicialFsStateFetcherCfg config.AtipicialFsStateFetcher
	}
)
...
func NewServerConfig(cfg config.Config) (ServerConfig, error) {
	...
	c := ServerConfig{
		...
		AtipicialFsBlockFetcherCfg:   appConfig.AtipicialFsBlockFetcher,
		AtipicialFsStateFetcherCfg:   appConfig.AtipicialFsStateFetcher,
	}
	return c, nil
}
