...
func TestVerackAfterHandleVersionCmd(t *testing.T) {
	...
	version := payload.NewVersion(0, 1337, "/ATIPICIAL-GO/", capabilities)
...
func TestServerNotSendsVerack(t *testing.T) {
	...
	// identical id's
	version := payload.NewVersion(56753, 1, "/ATIPICIAL-GO/", capabilities)
