...
func TestIsReserved(t *testing.T) {
	...
	// Ref. https://github.com/atipicial-project/atipicial-node/pull/1066.
	t.Run("compat", func(t *testing.T) {
		for _, tc := range []struct {
			...
			// 6to4 Encapsulated (the fixed bug, ref. https://github.com/atipicial-project/atipicial-node/pull/1066)
