...
func putOracleRequest(t *testing.T, oracleValidatorInvoker *atipicialtest.ContractInvoker,
...
// https://github.com/atipicial-project/atipicial-modules/blob/master/tests/Atipicial.Plugins.OracleService.Tests/UT_OracleService.cs#L61
...
func TestOracle(t *testing.T) {
	...
	orc1.UpdateNativeContract(nativeOracleState.AEF.Script, bytes.Clone(oracleRespScript), nativeOracleH, md.Offset)
	orc2.UpdateNativeContract(nativeOracleState.AEF.Script, bytes.Clone(oracleRespScript), nativeOracleH, md.Offset)
