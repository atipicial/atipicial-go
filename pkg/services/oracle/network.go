...
// Ref. https://github.com/atipicial-project/atipicial-node/blob/36904b643ac6e979d5d2a6782034038c9db20732/plugins/OracleService/Helper.cs#L60.
...
func isReserved(ip net.IP) bool {
	...
	// Ref. https://github.com/atipicial-project/atipicial-node/blob/36904b643ac6e979d5d2a6782034038c9db20732/plugins/OracleService/Helper.cs#L62
...
func getDefaultClient(cfg config.OracleConfiguration) *http.Client {
	...
	client.CheckRedirect = func(req *http.Request, via []*http.Request) error {
		if len(via) > maxRedirections { // from https://github.com/atipicial-project/atipicial-modules/pull/698
