...
// RPC error codes defined by the Atipicial JSON-RPC specification extension.
...
// see the https://github.com/atipicial/atipicial-go/blob/master/docs/rpc.md#unsupported-methods.
const (
