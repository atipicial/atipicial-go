...
type (
	...
	RPC struct {
		...
		// Below are AtipicialGo-specific extensions to the JSON-RPC protocol that are
	...
	Protocol struct {
		...
		// Below are AtipicialGo-specific extensions to the protocol that are
		// returned by the server in case they're enabled.
	...
	// Application is a AtipicialGo-specific extension to the node that is
