...
func TestVersion_MarshalUnmarshalJSON(t *testing.T) {
	...
	responseFromGoNew := `{
        ...
        "protocol": {
            ...
            "seedlist": ["seed1.atipicial.com:103333", "seed2.atipicial.com:103333"],
	...
	v := &Version{
		...
		Protocol: Protocol{
			...
			SeedList: []string{
				"seed1.atipicial.com:103333",
				"seed2.atipicial.com:103333",
			},
		},
	...
	t.Run("UnmarshalJSON", func(t *testing.T) {
		...
		t.Run("Sharp node response", func(t *testing.T) {
			...
			*expected = *v
			expected.UserAgent = "/Atipicial:3.1.0/"
			// We set SaveInvocations, KeepOnlyLatestState and
			// RemoveUntraceableBlocks to false because these are AtipicialGo node
			// extensions.
