...
func TestGetPeers(t *testing.T) {
	...
	gp.AddConnected([]network.PeerInfo{
		{Address: "192.168.0.1:10333", UserAgent: "/ATIPICIAL-GO:0.106.2/", Height: 100},
		{Address: unsupportedFormat, UserAgent: "", Height: 0},
		{Address: "[2001:DB0:0:123A::]:30", UserAgent: "/ATIPICIAL-GO:0.106.2/", Height: 200},
	})
	...
	require.Equal(t, "/ATIPICIAL-GO:0.106.2/", gp.Connected[0].UserAgent)
	require.Equal(t, uint32(100), gp.Connected[0].LastKnownHeight)
	require.Equal(t, uint16(30), gp.Connected[1].Port)
	require.Equal(t, "/ATIPICIAL-GO:0.106.2/", gp.Connected[1].UserAgent)
