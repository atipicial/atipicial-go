...
const (
	// The current version of atipicial-go wallet implementations.
	walletVersion = "1.0"
)
...
// Wallet represents a ATC (AEP-2, AEP-6) compliant wallet.
type Wallet struct {
...
// NewWallet creates a new ATC wallet at the given location.
...
// NewInMemoryWallet creates a new ATC wallet without linking to the read file on file system.
