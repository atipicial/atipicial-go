...
Atipicial storage's model follows simple key-value DB pattern, this storage is a part
...
// to Atipicial .net framework's StorageContext class.
type Context struct{}
...
func ConvertContextToReadOnly(ctx Context) Context {
	return atipicialgointernal.Syscall1("System.Storage.AsReadOnly", ctx).(Context)
}
...
func GetContext() Context {
	return atipicialgointernal.Syscall0("System.Storage.GetContext").(Context)
}
...
func GetReadOnlyContext() Context {
	return atipicialgointernal.Syscall0("System.Storage.GetReadOnlyContext").(Context)
}
...
func Put(ctx Context, key any, value any) {
	atipicialgointernal.Syscall3NoReturn("System.Storage.Put", ctx, key, value)
}

// LocalPut is similar to Put, but does not require context.
func LocalPut(key []byte, value []byte) {
	atipicialgointernal.Syscall2NoReturn("System.Storage.Local.Put", key, value)
}
...
func Get(ctx Context, key any) any {
	return atipicialgointernal.Syscall2("System.Storage.Get", ctx, key)
}

// LocalGet is similar to Get, but does not require context.
func LocalGet(key []byte) []byte {
	return atipicialgointernal.Syscall1("System.Storage.Local.Get", key).([]byte)
}
...
func Delete(ctx Context, key any) {
	atipicialgointernal.Syscall2NoReturn("System.Storage.Delete", ctx, key)
}

// LocalDelete is similar to Delete, but does not require context.
func LocalDelete(key []byte) {
	atipicialgointernal.Syscall1NoReturn("System.Storage.Local.Delete", key)
}
...
func Find(ctx Context, key any, options FindFlags) iterator.Iterator {
	return atipicialgointernal.Syscall3("System.Storage.Find", ctx, key, options).(iterator.Iterator)
}

// LocalFind is similar to Find, but does not require context.
func LocalFind(key []byte, options FindFlags) iterator.Iterator {
	return atipicialgointernal.Syscall2("System.Storage.Local.Find", key, options).(iterator.Iterator)
}
