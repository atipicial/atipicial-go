...
be substituted with appropriate AtipicialVM system calls implemented by Atipicial. Usually
these system calls have additional price in AtipicialVM, so they're explicitly written
