...
func CreateMultisigAccount(m int, pubs []interop.PublicKey) []byte {
	return atipicialgointernal.Syscall2("System.Contract.CreateMultisigAccount", m, pubs).([]byte)
}
...
func CreateStandardAccount(pub interop.PublicKey) []byte {
	return atipicialgointernal.Syscall1("System.Contract.CreateStandardAccount", pub).([]byte)
}
...
func GetCallFlags() CallFlag {
	return atipicialgointernal.Syscall0("System.Contract.GetCallFlags").(CallFlag)
}
...
func Call(scriptHash interop.Hash160, method string, f CallFlag, args ...any) any {
	return atipicialgointernal.Syscall4("System.Contract.Call", scriptHash, method, f, args)
}
