...
It has similar function to Runtime class in .net framework for Atipicial.
*/
package runtime
...
func BurnGas(gas int) {
	atipicialgointernal.Syscall1NoReturn("System.Runtime.BurnGas", gas)
}
...
func CheckWitness(hashOrKey []byte) bool {
	return atipicialgointernal.Syscall1("System.Runtime.CheckWitness", hashOrKey).(bool)
}
...
func CurrentSigners() []ledger.TransactionSigner {
	return atipicialgointernal.Syscall0("System.Runtime.CurrentSigners").([]ledger.TransactionSigner)
}
...
func LoadScript(script []byte, f contract.CallFlag, args ...any) any {
	return atipicialgointernal.Syscall3("System.Runtime.LoadScript", script, f, args)
}
...
func Log(message string) {
	atipicialgointernal.Syscall1NoReturn("System.Runtime.Log", message)
}
...
func Notify(name string, args ...any) {
	atipicialgointernal.Syscall2NoReturn("System.Runtime.Notify", name, args)
}

// GetAddressVersion returns the address version of the current protocol. The
// address version represents the byte used to prepend to Atipicial addresses when
// encoding them. The default value for Atipicial is 53 (0x35). This function uses
// `System.Runtime.GetAddressVersion` syscall.
func GetAddressVersion() int {
	return atipicialgointernal.Syscall0("System.Runtime.GetAddressVersion").(int)
}

// GetNetwork returns network magic number. This function uses
// `System.Runtime.GetNetwork` syscall.
func GetNetwork() int {
	return atipicialgointernal.Syscall0("System.Runtime.GetNetwork").(int)
}
...
func GetTime() int {
	return atipicialgointernal.Syscall0("System.Runtime.GetTime").(int)
}
...
func GetTrigger() byte {
	return atipicialgointernal.Syscall0("System.Runtime.GetTrigger").(byte)
}

// GasLeft returns the amount of gas available for the current execution.
// This function uses `System.Runtime.GasLeft` syscall.
func GasLeft() int {
	return atipicialgointernal.Syscall0("System.Runtime.GasLeft").(int)
}
...
func GetNotifications(h interop.Hash160) [][]any {
	return atipicialgointernal.Syscall1("System.Runtime.GetNotifications", h).([][]any)
}
...
func GetInvocationCounter() int {
	return atipicialgointernal.Syscall0("System.Runtime.GetInvocationCounter").(int)
}

// Platform returns the platform name, which is set to be `ATC`. This function uses
// `System.Runtime.Platform` syscall.
func Platform() []byte {
	return atipicialgointernal.Syscall0("System.Runtime.Platform").([]byte)
}
...
func GetRandom() int {
	return atipicialgointernal.Syscall0("System.Runtime.GetRandom").(int)
}
