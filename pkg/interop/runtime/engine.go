...
func GetScriptContainer() *ledger.Transaction {
	return atipicialgointernal.Syscall0("System.Runtime.GetScriptContainer").(*ledger.Transaction)
}
...
func GetExecutingScriptHash() interop.Hash160 {
	return atipicialgointernal.Syscall0("System.Runtime.GetExecutingScriptHash").(interop.Hash160)
}
...
func GetCallingScriptHash() interop.Hash160 {
	return atipicialgointernal.Syscall0("System.Runtime.GetCallingScriptHash").(interop.Hash160)
}
...
func GetEntryScriptHash() interop.Hash160 {
	return atipicialgointernal.Syscall0("System.Runtime.GetEntryScriptHash").(interop.Hash160)
}
