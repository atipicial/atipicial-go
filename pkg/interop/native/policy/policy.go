...
func GetFeePerByte() int {
	return atipicialgointernal.CallWithToken(Hash, "getFeePerByte", int(contract.ReadStates)).(int)
}

// SetFeePerByte represents `setFeePerByte` method of Policy native contract.
func SetFeePerByte(value int) {
	atipicialgointernal.CallWithTokenNoRet(Hash, "setFeePerByte", int(contract.States), value)
}
...
func GetExecFeeFactor() int {
	return atipicialgointernal.CallWithToken(Hash, "getExecFeeFactor", int(contract.ReadStates)).(int)
}
...
func GetExecPicoFeeFactor() int {
	return atipicialgointernal.CallWithToken(Hash, "getExecPicoFeeFactor", int(contract.ReadStates)).(int)
}
...
func SetExecFeeFactor(value int) {
	atipicialgointernal.CallWithTokenNoRet(Hash, "setExecFeeFactor", int(contract.States), value)
}

// GetStoragePrice represents `getStoragePrice` method of Policy native contract.
func GetStoragePrice() int {
	return atipicialgointernal.CallWithToken(Hash, "getStoragePrice", int(contract.ReadStates)).(int)
}

// SetStoragePrice represents `setStoragePrice` method of Policy native contract.
func SetStoragePrice(value int) {
	atipicialgointernal.CallWithTokenNoRet(Hash, "setStoragePrice", int(contract.States), value)
}

// GetAttributeFee represents `getAttributeFee` method of Policy native contract.
func GetAttributeFee(t AttributeType) int {
	return atipicialgointernal.CallWithToken(Hash, "getAttributeFee", int(contract.ReadStates), t).(int)
}
...
func SetAttributeFee(t AttributeType, value int) {
	atipicialgointernal.CallWithTokenNoRet(Hash, "setAttributeFee", int(contract.States), t, value)
}

// IsBlocked represents `isBlocked` method of Policy native contract.
func IsBlocked(addr interop.Hash160) bool {
	return atipicialgointernal.CallWithToken(Hash, "isBlocked", int(contract.ReadStates), addr).(bool)
}

// BlockAccount represents `blockAccount` method of Policy native contract.
func BlockAccount(addr interop.Hash160) bool {
	return atipicialgointernal.CallWithToken(Hash, "blockAccount", int(contract.States|contract.AllowNotify), addr).(bool)
}

// UnblockAccount represents `unblockAccount` method of Policy native contract.
func UnblockAccount(addr interop.Hash160) bool {
	return atipicialgointernal.CallWithToken(Hash, "unblockAccount", int(contract.States), addr).(bool)
}
...
func GetMaxValidUntilBlockIncrement() int {
	return atipicialgointernal.CallWithToken(Hash, "getMaxValidUntilBlockIncrement", int(contract.ReadStates)).(int)
}
...
func SetMaxValidUntilBlockIncrement(value int) {
	atipicialgointernal.CallWithTokenNoRet(Hash, "setMaxValidUntilBlockIncrement", int(contract.States), value)
}
...
func GetMillisecondsPerBlock() int {
	return atipicialgointernal.CallWithToken(Hash, "getMillisecondsPerBlock", int(contract.ReadStates)).(int)
}
...
func SetMillisecondsPerBlock(value int) {
	atipicialgointernal.CallWithTokenNoRet(Hash, "setMillisecondsPerBlock", int(contract.States|contract.AllowNotify), value)
}
...
func GetBlockedAccounts() iterator.Iterator {
	return atipicialgointernal.CallWithToken(Hash, "getBlockedAccounts", int(contract.ReadStates)).(iterator.Iterator)
}
...
func SetWhitelistFeeContract(hash interop.Hash160, method string, argCnt int, fixedFee int) {
	atipicialgointernal.CallWithTokenNoRet(Hash, "setWhitelistFeeContract", int(contract.States|contract.AllowNotify),
...
func RemoveWhitelistFeeContract(hash interop.Hash160, method string, argCnt int) {
	atipicialgointernal.CallWithTokenNoRet(Hash, "removeWhitelistFeeContract", int(contract.States|contract.AllowNotify),
		hash, method, argCnt)
}
...
func GetWhitelistFeeContracts() iterator.Iterator {
	return atipicialgointernal.CallWithToken(Hash, "getWhitelistFeeContracts", int(contract.ReadStates)).(iterator.Iterator)
}
...
func RecoverFund(account interop.Hash160, token interop.Hash160) bool {
	return atipicialgointernal.CallWithToken(Hash, "recoverFund", int(contract.States|contract.AllowCall|contract.AllowNotify), account, token).(bool)
}
