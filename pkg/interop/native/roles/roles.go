...
func GetDesignatedByRole(r Role, height uint32) []interop.PublicKey {
	return atipicialgointernal.CallWithToken(Hash, "getDesignatedByRole",
...
func DesignateAsRole(r Role, pubs []interop.PublicKey) {
	atipicialgointernal.CallWithTokenNoRet(Hash, "designateAsRole",
