...
func Serialize(item any) []byte {
	return atipicialgointernal.CallWithToken(Hash, "serialize", int(contract.NoneFlag),
		item).([]byte)
}
...
func Deserialize(b []byte) any {
	return atipicialgointernal.CallWithToken(Hash, "deserialize", int(contract.NoneFlag),
		b)
}
...
func JSONSerialize(item any) []byte {
	return atipicialgointernal.CallWithToken(Hash, "jsonSerialize", int(contract.NoneFlag),
		item).([]byte)
}
...
func JSONDeserialize(data []byte) any {
	return atipicialgointernal.CallWithToken(Hash, "jsonDeserialize", int(contract.NoneFlag),
		data)
}
...
func Base64Encode(b []byte) string {
	return atipicialgointernal.CallWithToken(Hash, "base64Encode", int(contract.NoneFlag),
		b).(string)
}
...
func Base64Decode(b []byte) []byte {
	return atipicialgointernal.CallWithToken(Hash, "base64Decode", int(contract.NoneFlag),
		b).([]byte)
}
...
func Base58Encode(b []byte) string {
	return atipicialgointernal.CallWithToken(Hash, "base58Encode", int(contract.NoneFlag),
		b).(string)
}
...
func Base58Decode(b []byte) []byte {
	return atipicialgointernal.CallWithToken(Hash, "base58Decode", int(contract.NoneFlag),
		b).([]byte)
}
...
func Base58CheckEncode(b []byte) string {
	return atipicialgointernal.CallWithToken(Hash, "base58CheckEncode", int(contract.NoneFlag),
		b).(string)
}
...
func Base58CheckDecode(b []byte) []byte {
	return atipicialgointernal.CallWithToken(Hash, "base58CheckDecode", int(contract.NoneFlag),
		b).([]byte)
}
...
func Itoa(num int, base int) string {
	return atipicialgointernal.CallWithToken(Hash, "itoa", int(contract.NoneFlag),
		num, base).(string)
}
...
func Atoi(s string, base int) int {
	return atipicialgointernal.CallWithToken(Hash, "atoi", int(contract.NoneFlag),
		s, base).(int)
}
...
func MemoryCompare(s1, s2 []byte) int {
	return atipicialgointernal.CallWithToken(Hash, "memoryCompare", int(contract.NoneFlag),
		s1, s2).(int)
}
...
func MemorySearch(mem, pattern []byte) int {
	return atipicialgointernal.CallWithToken(Hash, "memorySearch", int(contract.NoneFlag),
		mem, pattern).(int)
}
...
func StringSplit(s, sep string) []string {
	return atipicialgointernal.CallWithToken(Hash, "stringSplit", int(contract.NoneFlag),
		s, sep).([]string)
}
...
func StrLen(s string) int {
	return atipicialgointernal.CallWithToken(Hash, "strLen", int(contract.NoneFlag),
		s).(int)
}
...
func HexEncode(b []byte) string {
	return atipicialgointernal.CallWithToken(Hash, "hexEncode", int(contract.NoneFlag),
		b).(string)
}
...
func HexDecode(s string) []byte {
	return atipicialgointernal.CallWithToken(Hash, "hexDecode", int(contract.NoneFlag),
		s).([]byte)
}
