...
This contract is a AtipicialGo extension and is not available on regular Atipicial
...
func LockDepositUntil(addr interop.Hash160, till int) bool {
	return atipicialgointernal.CallWithToken(Hash, "lockDepositUntil", int(contract.States),
		addr, till).(bool)
}

// Withdraw represents `withdraw` method of Notary native contract.
func Withdraw(from, to interop.Hash160) bool {
	return atipicialgointernal.CallWithToken(Hash, "withdraw", int(contract.All),
		from, to).(bool)
}
...
func ExpirationOf(addr interop.Hash160) int {
	return atipicialgointernal.CallWithToken(Hash, "expirationOf", int(contract.ReadStates), addr).(int)
}
...
func GetMaxNotValidBeforeDelta() int {
	return atipicialgointernal.CallWithToken(Hash, "getMaxNotValidBeforeDelta", int(contract.ReadStates)).(int)
}
...
func SetMaxNotValidBeforeDelta(value int) {
	atipicialgointernal.CallWithTokenNoRet(Hash, "setMaxNotValidBeforeDelta", int(contract.States), value)
}
