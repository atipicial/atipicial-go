...
func Deploy(script, manifest []byte) *Contract {
	return atipicialgointernal.CallWithToken(Hash, "deploy",
...
func Destroy() {
	atipicialgointernal.CallWithTokenNoRet(Hash, "destroy", int(contract.States|contract.AllowNotify))
}

// GetContract represents `getContract` method of Management native contract.
func GetContract(addr interop.Hash160) *Contract {
	return atipicialgointernal.CallWithToken(Hash, "getContract", int(contract.ReadStates), addr).(*Contract)
}

// GetContractByID represents `getContractById` method of the Management native contract.
func GetContractByID(id int) *Contract {
	return atipicialgointernal.CallWithToken(Hash, "getContractById", int(contract.ReadStates), id).(*Contract)
}
...
func GetContractHashes() iterator.Iterator {
	return atipicialgointernal.CallWithToken(Hash, "getContractHashes", int(contract.ReadStates)).(iterator.Iterator)
}
...
func GetMinimumDeploymentFee() int {
	return atipicialgointernal.CallWithToken(Hash, "getMinimumDeploymentFee", int(contract.ReadStates)).(int)
}
...
func HasMethod(hash interop.Hash160, method string, pcount int) bool {
	return atipicialgointernal.CallWithToken(Hash, "hasMethod", int(contract.ReadStates), hash, method, pcount).(bool)
}
...
func SetMinimumDeploymentFee(value int) {
	atipicialgointernal.CallWithTokenNoRet(Hash, "setMinimumDeploymentFee", int(contract.States), value)
}

// Update represents `update` method of Management native contract.
func Update(script, manifest []byte) {
	atipicialgointernal.CallWithTokenNoRet(Hash, "update",
...
func IsContract(hash interop.Hash160) bool {
	return atipicialgointernal.CallWithToken(Hash, "isContract", int(contract.ReadStates), hash).(bool)
}
