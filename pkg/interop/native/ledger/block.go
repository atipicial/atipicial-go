...
// Block represents a ATC block, it's a data structure where you can get
// block-related data from. It's similar to the Block class in the Atipicial .net
...
// BlockSR is a stateroot-enabled Atipicial block. It's returned from the Ledger contract's
// GetBlock method when StateRootInHeader AtipicialGo extension  is used. Use it only when
