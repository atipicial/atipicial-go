...
func Sha256(b []byte) interop.Hash256 {
	return atipicialgointernal.CallWithToken(Hash, "sha256", int(contract.NoneFlag), b).(interop.Hash256)
}
...
func Ripemd160(b []byte) interop.Hash160 {
	return atipicialgointernal.CallWithToken(Hash, "ripemd160", int(contract.NoneFlag), b).(interop.Hash160)
}
...
func Murmur32(b []byte, seed int) []byte {
	return atipicialgointernal.CallWithToken(Hash, "murmur32", int(contract.NoneFlag), b, seed).([]byte)
}
...
func VerifyWithECDsa(msg []byte, pub interop.PublicKey, sig interop.Signature, curveHash NamedCurveHash) bool {
	return atipicialgointernal.CallWithToken(Hash, "verifyWithECDsa", int(contract.NoneFlag), msg, pub, sig, curveHash).(bool)
}
...
func VerifyWithEd25519(msg []byte, pub []byte, sig []byte) bool {
	return atipicialgointernal.CallWithToken(Hash, "verifyWithEd25519", int(contract.NoneFlag), msg, pub, sig).(bool)
}
...
func RecoverSecp256K1(msgHash []byte, sig []byte) []byte {
	return atipicialgointernal.CallWithToken(Hash, "recoverSecp256K1", int(contract.NoneFlag), msgHash, sig).([]byte)
}
...
func Bls12381Serialize(g Bls12381Point) []byte {
	return atipicialgointernal.CallWithToken(Hash, "bls12381Serialize", int(contract.NoneFlag), g).([]byte)
}
...
func Bls12381Deserialize(data []byte) Bls12381Point {
	return atipicialgointernal.CallWithToken(Hash, "bls12381Deserialize", int(contract.NoneFlag), data).(Bls12381Point)
}
...
func Bls12381Equal(x, y Bls12381Point) bool {
	return atipicialgointernal.CallWithToken(Hash, "bls12381Equal", int(contract.NoneFlag), x, y).(bool)
}
...
func Bls12381Add(x, y Bls12381Point) Bls12381Point {
	return atipicialgointernal.CallWithToken(Hash, "bls12381Add", int(contract.NoneFlag), x, y).(Bls12381Point)
}
...
func Bls12381Mul(x Bls12381Point, mul []byte, neg bool) Bls12381Point {
	return atipicialgointernal.CallWithToken(Hash, "bls12381Mul", int(contract.NoneFlag), x, mul, neg).(Bls12381Point)
}
...
func Bls12381Pairing(g1, g2 Bls12381Point) Bls12381Point {
	return atipicialgointernal.CallWithToken(Hash, "bls12381Pairing", int(contract.NoneFlag), g1, g2).(Bls12381Point)
}
...
func Keccak256(b []byte) interop.Hash256 {
	return atipicialgointernal.CallWithToken(Hash, "keccak256", int(contract.NoneFlag), b).(interop.Hash256)
}
