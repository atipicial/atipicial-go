/*
Package iterator provides functions to work with Atipicial iterators.
*/
package iterator

import "github.com/atipicial/atipicial-go/pkg/interop/atipicialgointernal"

// Iterator represents a Atipicial iterator, it's an opaque data structure that can
...
// function to Atipicial .net framework's Iterator.
...
func Next(it Iterator) bool {
	return atipicialgointernal.Syscall1("System.Iterator.Next", it).(bool)
}
...
func Value(it Iterator) any {
	return atipicialgointernal.Syscall1("System.Iterator.Value", it)
}
