...
type decoder struct {
	...
	// be used to parse big.Int items. If false, then default AtipicialC# value will be
...
const (
	...
	// parse big numbers, see the https://github.com/atipicial-project/atipicial/issues/2879.
...
func itemToJSONString(it Item) ([]byte, error) {
	...
	// ref https://github.com/atipicial-project/atipicial-modules/issues/375 and https://github.com/dotnet/runtime/issues/35281
