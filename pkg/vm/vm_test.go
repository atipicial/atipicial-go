...
// Ref. https://github.com/atipicial-project/atipicial-vm/issues/580.
...
func TestNestedStructClone(t *testing.T) {
	progs := []string{
		// VALUES for deeply nested structs, see atipicial-project/atipicial#2534.
...
func TestNestedStructEquals(t *testing.T) {
	h := "560112c501fe0160589d604a12c0db415824f7509d4a102aec4597" // See atipicial-project/atipicial-vm#426.
	prog, err := hex.DecodeString(h)
	require.NoError(t, err)
	vm := load(prog)
	checkVMFailed(t, vm)
