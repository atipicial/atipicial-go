...
import (
	...
	"github.com/github.com/atipicial/rfc6979"
)

// PrivateKey represents a Atipicial private key and provides a high level API around
// ecdsa.PrivateKey.
...
// NewPrivateKeyFromBytes returns a ATC Secp256r1 PrivateKey from the given
// byte slice.
...
// NewPrivateKeyFromASN1 returns a ATC Secp256k1 PrivateKey from the ASN.1
// serialized key.
...
// NewPrivateKeyFromWIF returns a ATC PrivateKey from the given
...
// Address derives the public ATC address that is coupled with the private key, and
