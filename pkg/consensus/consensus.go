...
import (
	...
	"github.com/github.com/atipicial/dbft/timer"
	...
	npayload "github.com/atipicial/atipicial-go/pkg/network/payload"
...
// from C# implementation https://github.com/atipicial-project/atipicial/blob/master/atipicial/Ledger/Blockchain.cs#L64
...
var (
	...
	_ dbft.Block[util.Uint256]       = (*atipicialBlock)(nil)
)
...
func (s *service) verifyBlock(b dbft.Block[util.Uint256]) bool {
	...
	var fee int64
	var pool = mempool.New(len(coreb.Transactions), false, nil)
...
func (s *service) getBlock(h util.Uint256) dbft.Block[util.Uint256] {
	...
	return &atipicialBlock{network: s.ProtocolConfiguration.Magic, Block: *b}
}
...
func (s *service) getValidators(txes ...dbft.Transaction[util.Uint256]) []dbft.PublicKey {
	...
	// NextConsensus field, but AtipicialGo doesn't provide WithGetConsensusAddress
...
func (s *service) newBlockFromContext(ctx *dbft.Context[util.Uint256]) dbft.Block[util.Uint256] {
	block := &atipicialBlock{network: s.ProtocolConfiguration.Magic}
	...
	// ATC votes; in this case list of validators may differ from the one returned
	...
	// (i.e. PostPersist was completed for native Atipicial contract and PostPersist
