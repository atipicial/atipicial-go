...
const (
	// MaxBytesLen is the maximum length of a serialized integer suitable for Atipicial VM.
...
// Note: ATIPICIAL serialization differs from default C# BigInteger.ToByteArray()
// when n == 0. For zero is equal to empty slice in ATIPICIAL.
//
// https://github.com/atipicial-project/atipicial-vm/blob/master/src/atipicial-vm/Types/Integer.cs#L16
