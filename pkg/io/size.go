...
// (reference: GetVarSize(int value),  https://github.com/atipicial-project/atipicial/blob/master/atipicial/IO/Helper.cs)
...
// them with variable-length encoding that is used in Atipicial), strings, pointers to Serializable structures,
