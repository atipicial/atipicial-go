...
type Genesis struct {
	...
	// Designation contract initialization. It is AtipicialGo extension and must be
	// disabled on the public Atipicial  networks.
	...
	// genesis block. It is AtipicialGo extension and must be disabled on the public
	// Atipicial  networks.
