...
type (
	ProtocolConfiguration struct {
		...
		// Genesis stores genesis-related settings including a set of AtipicialGo
		...
		// AtipicialFsStateSyncExtensions enables state data exchange logic via AtipicialFs.
		AtipicialFsStateSyncExtensions bool `yaml:"AtipicialFsStateSyncExtensions"`
