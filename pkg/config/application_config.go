...
type ApplicationConfiguration struct {
	...
	AtipicialFsBlockFetcher AtipicialFsBlockFetcher   `yaml:"AtipicialFsBlockFetcher"`
	AtipicialFsStateFetcher AtipicialFsStateFetcher   `yaml:"AtipicialFsStateFetcher"`
}
...
func (a *ApplicationConfiguration) Validate() error {
	if err := a.AtipicialFsBlockFetcher.Validate(); err != nil {
		return fmt.Errorf("invalid AtipicialFsBlockFetcher config: %w", err)
	}
	// If AtipicialFsService configuration is omitted the AtipicialFsBlockFetcher.AtipicialFsService will be used.
	if a.AtipicialFsStateFetcher.Enabled && a.AtipicialFsBlockFetcher.Enabled && a.AtipicialFsStateFetcher.ContainerID == "" {
		a.AtipicialFsStateFetcher.AtipicialFsService = a.AtipicialFsBlockFetcher.AtipicialFsService
	}
	if err := a.AtipicialFsStateFetcher.Validate(); err != nil {
		return fmt.Errorf("invalid AtipicialFsStateFetcher config: %w", err)
	}
