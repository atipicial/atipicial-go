...
const (
	...
	// https://github.com/atipicial-project/atipicial/pull/2712) and #2519 (ported from
	// https://github.com/atipicial-project/atipicial/pull/2749).
	HFAspidochelone Hardfork = 1 + iota // Aspidochelone
	// HFBasilisk represents hard-fork introduced in #3056 (ported from
	// https://github.com/atipicial-project/atipicial/pull/2881), #3080 (ported from
	// https://github.com/atipicial-project/atipicial/pull/2883) and #3085 (ported from
	// https://github.com/atipicial-project/atipicial/pull/2810).
	HFBasilisk // Basilisk
	// HFCockatrice represents hard-fork introduced in #3402 (ported from
	// https://github.com/atipicial-project/atipicial/pull/2942), #3301 (ported from
	// https://github.com/atipicial-project/atipicial/pull/2925) and #3362 (ported from
	// https://github.com/atipicial-project/atipicial/pull/3154).
	HFCockatrice // Cockatrice
	// HFDomovoi represents hard-fork introduced in #3476 (ported from
	// https://github.com/atipicial-project/atipicial/pull/3290). It makes the`node use
	...
	// in [#3473](https://github.com/atipicial/atipicial-go/pull/3473) and ported to
	// the [reference](https://github.com/atipicial-project/atipicial/pull/3290). Also, this
	...
	// [reference](https://github.com/atipicial-project/atipicial/pull/3301), but AtipicialGo has
	...
	// https://github.com/atipicial-project/atipicial/pull/3454), #3640 (ported from
	// https://github.com/atipicial-project/atipicial/pull/3548), #3863 (ported from
	// https://github.com/atipicial-project/atipicial/pull/3696), #3835 (ported from
	// https://github.com/atipicial-project/atipicial/pull/3895), #3854 (ported from
	// https://github.com/atipicial-project/atipicial/pull/3175).
	HFEchidna // Echidna
	// HFFaun represents hard-fork introduced in #3931, #4004 (ported from
	// https://github.com/atipicial-project/atipicial/pull/4147,
	// https://github.com/atipicial-project/atipicial/pull/4150), #4057 (ported from
	// https://github.com/atipicial-project/atipicial/pull/4278), #4052 (ported from
	// https://github.com/atipicial-project/atipicial/pull/4201), #4139 (ported from
	// https://github.com/atipicial-project/atipicial/pull/4328).
	HFFaun // Faun
	// HFGorgon represents hard-fork introduced in #4142, #4197 (ported from
	// https://github.com/atipicial-project/atipicial/pull/4516 and
	// https://github.com/atipicial-project/atipicial-vm/pull/543), #4233 (ported from
	// https://github.com/atipicial-project/atipicial/pull/4539), #4236 (ported from
	// https://github.com/atipicial-project/atipicial/pull/4449).
	HFGorgon // Gorgon
	// HFHuyao represents hard-fork introduced in #4330 (ported from
	// https://github.com/atipicial-project/atipicial/pull/4571).
	HFHuyao // Huyao
