...
func TestGetAddresses(t *testing.T) {
	...
	cases := []testcase{
		...
		{
			cfg: &ApplicationConfiguration{
				P2P: P2P{Addresses: []string{v6Plain0, v6Plain1, v6Plain2, v6Plai, v6Plain4}},
			},
			expected: []AnnounceableAddress{
				{Address: v6Plain0},
				{Address: v6Plain1},
...
func TestApplicationConfiguration_Validate(t *testing.T) {
	...
	cases := []testcase{
		{
			cfg: ApplicationConfiguration{
				AtipicialFsBlockFetcher: AtipicialFsBlockFetcher{
					AtipicialFsService: AtipicialFsService{
