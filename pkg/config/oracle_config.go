...
type OracleConfiguration struct {
	...
	AtipicialFs                 AtipicialFsConfiguration `yaml:"AtipicialFs"`
...
// AtipicialFsConfiguration is a config for the AtipicialFs service.
type AtipicialFsConfiguration struct {
	Nodes   []string      `yaml:"Nodes"`
