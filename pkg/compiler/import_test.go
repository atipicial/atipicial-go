...
func TestImportStruct(t *testing.T) {
	src := `
		...
		import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/bar"
...
func TestMultipleDirFileImport(t *testing.T) {
	src := `
		...
		import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/foobar"
...
func TestImportCycleIndirect(t *testing.T) {
	src := `
		package some
		import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/importcycle/pkg1"
		func Main() int {
			return pkg1.A
		}
	`
...
func TestImportPackageError(t *testing.T) {
	src := `package foo
		import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/importerr"
