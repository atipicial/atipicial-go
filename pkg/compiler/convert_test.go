...
func TestConvert(t *testing.T) {
	...
	srcBuilder := bytes.NewBuffer([]byte(`package testcase
		import "github.com/atipicial/atipicial-go/pkg/interop/convert"
	`))
...
func TestSelectorTypeConversion(t *testing.T) {
	src := `package foo
	import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/types"
