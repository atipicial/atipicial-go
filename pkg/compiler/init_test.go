...
func TestImportOrder(t *testing.T) {
	t.Run("1,2", func(t *testing.T) {
		src := `package foo
		import _ "github.com/atipicial/atipicial-go/pkg/compiler/testdata/pkg1"
		import _ "github.com/atipicial/atipicial-go/pkg/compiler/testdata/pkg2"
		import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/pkg3"
