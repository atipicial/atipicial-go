...
func TestReturnValueReceiver(t *testing.T) {
	t.Run("regular", func(t *testing.T) {
		src := `package foo
		import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/method"
	...
	t.Run("inline", func(t *testing.T) {
		src := `package foo
		import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/inline"
...
func TestNotAssignedFunctionCall(t *testing.T) {
	...
	t.Run("Builtin", func(t *testing.T) {
		src := `package foo
		import "github.com/atipicial/atipicial-go/pkg/interop/lib/address"
		func Main() int {
...
func TestUnusedFunctions(t *testing.T) {
	t.Run("only variable", func(t *testing.T) {
		src := `package foo
		import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/nestedcall"
		func Main() int {
			return nestedcall.X
		}`
	...
	t.Run("imported function", func(t *testing.T) {
		...
		src := `package foo
		import inner "github.com/atipicial/atipicial-go/pkg/compiler/testdata/nestedcall"
		func Main() int {
			return inner.N()
		}`
