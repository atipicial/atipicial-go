...
func TestInlineConversionQualified(t *testing.T) {
	...
	src2 := `package foo
	import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/inline"
	import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/inline/b"
	var A = 1
	func Main() int {
...
func TestInlineConditionalReturn(t *testing.T) {
	srcTmpl := `package foo
	import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/inline/c"
	func Main() int {
		x := %d
		if c.Is42(x) {
			return 100
...
func TestInlineModifyArg(t *testing.T) {
	src := `package foo
		import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/inline/d"
