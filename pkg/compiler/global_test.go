...
func TestUnusedOptimizedGlobalVar(t *testing.T) {
	...
	t.Run("single var decl token with multiple var specifications", func(t *testing.T) {
		...
		eval(t, src, big.NewInt(4), []any{opcode.INITSSLOT, []byte{3}}, // sslot for A, B, C
			// Global variables without explicit initializers are initialized first.
	...
	t.Run("imported", func(t *testing.T) {
		t.Run("init by func call", func(t *testing.T) {
			src := `package foo
					import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/globalvar"
					func Main() int {
		...
		t.Run("nested var call", func(t *testing.T) {
			src := `package foo
					import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/globalvar/nested1"
					func Main() int {
						return nested1.C
					}`
		...
		t.Run("nested func call", func(t *testing.T) {
			src := `package foo
					import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/globalvar/funccall"
					func Main() int {
						return funccall.F()
					}`
...
func TestMultipleFiles(t *testing.T) {
	src := `package foo
	import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/multi"
	func Main() int {
		return multi.Sum()
	}`
	eval(t, src, big.NewInt(42))
...
func TestExportedVariable(t *testing.T) {
	...
	t.Run("PackageAlias", func(t *testing.T) {
		src := `package foo
		import kek "github.com/atipicial/atipicial-go/pkg/compiler/testdata/multi"
		func Main() int {
			kek.SomeVar12 = 10
			return kek.Sum()
		}`
	...
	t.Run("DifferentName", func(t *testing.T) {
		src := `package foo
		import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/strange"
		func Main() int {
			normal.NormalVar = 42
...
func TestExportedConst(t *testing.T) {
	...
	t.Run("const only", func(t *testing.T) {
		src := `package foo
		import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/constonly"
		func Main() int {
...
func TestMultipleFuncSameName(t *testing.T) {
	...
	t.Run("WithMethod", func(t *testing.T) {
		src := `package foo
		import "github.com/atipicial/atipicial-go/pkg/compiler/testdata/foo"
		type Foo struct{}
