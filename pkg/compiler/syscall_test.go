...
func TestSyscallExecution(t *testing.T) {
	...
	srcBuilder.WriteString(`package foo
		...
		import "github.com/atipicial/atipicial-go/pkg/interop/iterator"
		import "github.com/atipicial/atipicial-go/pkg/interop/crypto"
...
func TestOpcode(t *testing.T) {
	...
	t.Run("2 arguments", func(t *testing.T) {
		...
		func add3(a, b, c int) int {
			return atipicialgointernal.Opcode2("SUB", a,
				atipicialgointernal.Opcode2("SUB", b, c).(int)).(int)
		}
		func Main() int {
			return add3(53, 12, 1)
		}`
	...
	t.Run("POW", func(t *testing.T) {
		src := `package foo
		import "github.com/atipicial/atipicial-go/pkg/interop/math"
		func Main() int {
